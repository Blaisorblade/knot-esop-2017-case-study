...
Section Shift.
  ...
  Proof.
    needleGenericWeakenAppend .
  Qed.
  Fixpoint shiftIndex (c : (Cutoff TmVar)) (x13 : (Index TmVar)) {struct c} :
  (Index TmVar) :=
    match c with
      | (C0) => (IS x13)
      | (CS c) => match x13 with
  ...
  Fixpoint tshiftPat (c : (Cutoff TyVar)) (p18 : Pat) {struct p18} :
  Pat :=
    match p18 with
      | (PVar T43) => (PVar (tshiftTy c T43))
      | (PProd p19 p20) => (PProd (tshiftPat c p19) (tshiftPat (weakenCutoffTyVar c (appendHvl H0 (bind p19))) p20))
    end.
  ...
  Tm :=
    match s with
      ...
      | (Case t34 p18 t35) => (Case (shiftTm c t34) p18 (shiftTm (weakenCutoffTmVar c (appendHvl H0 (bind p18))) t35))
    end.
  ...
  Tm :=
    match s with
      ...
      | (Case t34 p18 t35) => (Case (tshiftTm c t34) (tshiftPat c p18) (tshiftTm (weakenCutoffTyVar c (appendHvl H0 (bind p18))) t35))
    end.
End Shift.
...
Section Weaken.
  ...
  Pat :=
    match k with
      ...
      | (HS TyVar k) => (tshiftPat C0 (weakenPat p18 k))
    end.
...
Section Subst.
  ...
  Proof.
    needleGenericWeakenAppend .
  Qed.
  Fixpoint substIndex (d : (Trace TmVar)) (s : Tm) (x13 : (Index TmVar)) {struct d} :
  Tm :=
    match d with
      | (X0) => match x13 with
        | (I0) => s
      ...
      | (XS TyVar d) => (tshiftTm C0 (substIndex d s x13))
    end.
  ...
  Ty :=
    match S1 with
      ...
      | (TAll T45) => (TAll (tsubstTy (weakenTrace d (HS TyVar H0)) S0 T45))
      | (TProd T46 T47) => (TProd (tsubstTy d S0 T46) (tsubstTy d S0 T47))
    end.
  Fixpoint tsubstPat (d : (Trace TyVar)) (S0 : Ty) (p18 : Pat) {struct p18} :
  Pat :=
    match p18 with
      | (PVar T43) => (PVar (tsubstTy d S0 T43))
      | (PProd p19 p20) => (PProd (tsubstPat d S0 p19) (tsubstPat (weakenTrace d (appendHvl H0 (bind p19))) S0 p20))
    end.
  Fixpoint substTm (d : (Trace TmVar)) (s : Tm) (s0 : Tm) {struct s0} :
  Tm :=
    match s0 with
      | (Var x13) => (substIndex d s x13)
      | (Abs T43 t27) => (Abs T43 (substTm (weakenTrace d (HS TmVar H0)) s t27))
      | (App t28 t29) => (App (substTm d s t28) (substTm d s t29))
      | (TAbs t30) => (TAbs (substTm (weakenTrace d (HS TyVar H0)) s t30))
      | (TApp t31 T44) => (TApp (substTm d s t31) T44)
      | (Prod t32 t33) => (Prod (substTm d s t32) (substTm d s t33))
      | (Case t34 p18 t35) => (Case (substTm d s t34) p18 (substTm (weakenTrace d (appendHvl H0 (bind p18))) s t35))
    end.
  Fixpoint tsubstTm (d : (Trace TyVar)) (S0 : Ty) (s : Tm) {struct s} :
  Tm :=
    match s with
      | (Var x13) => (Var x13)
      | (Abs T43 t27) => (Abs (tsubstTy d S0 T43) (tsubstTm (weakenTrace d (HS TmVar H0)) S0 t27))
      | (App t28 t29) => (App (tsubstTm d S0 t28) (tsubstTm d S0 t29))
      | (TAbs t30) => (TAbs (tsubstTm (weakenTrace d (HS TyVar H0)) S0 t30))
      | (TApp t31 T44) => (TApp (tsubstTm d S0 t31) (tsubstTy d S0 T44))
      | (Prod t32 t33) => (Prod (tsubstTm d S0 t32) (tsubstTm d S0 t33))
      | (Case t34 p18 t35) => (Case (tsubstTm d S0 t34) (tsubstPat d S0 p18) (tsubstTm (weakenTrace d (appendHvl H0 (bind p18))) S0 t35))
    end.
End Subst.
...
Lemma stability_tsubst_bind  :
  (forall (p19 : Pat) ,
    (forall (d : (Trace TyVar)) (S0 : Ty) ,
      ((bind (tsubstPat d S0 p19)) = (bind p19)))).
Proof.
  apply_mutual_ind (ind_bind_Pat); simpl; intros; congruence .
Qed.
...
Section SubstShiftReflection.
  Lemma substIndex0_shiftIndex0_reflection_ind (s : Tm) :
    (forall (k : Hvl) (x13 : (Index TmVar)) ,
      ((substIndex (weakenTrace X0 k) s (shiftIndex (weakenCutoffTmVar C0 k) x13)) = (Var x13))).
  Proof.
  ...
  Lemma tsubstIndex0_tshiftIndex0_reflection_ind (S1 : Ty) :
    (forall (k : Hvl) (X12 : (Index TyVar)) ,
      ((tsubstIndex (weakenTrace X0 k) S1 (tshiftIndex (weakenCutoffTyVar C0 k) X12)) = (TVar X12))).
  Proof.
    needleGenericSubstIndexShiftIndexReflectionInd .
  Qed.
  ...
  ((tsubstTy (weakenTrace X0 k) S1 (tshiftTy (weakenCutoffTyVar C0 k) S2)) = S2) :=
    match S2 return ((tsubstTy (weakenTrace X0 k) S1 (tshiftTy (weakenCutoffTyVar C0 k) S2)) = S2) with
      ...
      | (TAll T43) => (f_equal TAll (eq_trans (f_equal3 tsubstTy (weakenTrace_append TyVar X0 k (HS TyVar H0)) eq_refl eq_refl) (tsubst0_tshift0_Ty_reflection_ind T43 (HS TyVar k) S1)))
  ...
  ((tsubstPat (weakenTrace X0 k) S1 (tshiftPat (weakenCutoffTyVar C0 k) p20)) = p20) :=
    match p20 return ((tsubstPat (weakenTrace X0 k) S1 (tshiftPat (weakenCutoffTyVar C0 k) p20)) = p20) with
      | (PVar T43) => (f_equal PVar (tsubst0_tshift0_Ty_reflection_ind T43 k S1))
      | (PProd p21 p22) => (f_equal2 PProd (tsubst0_tshift0_Pat_reflection_ind p21 k S1) (eq_trans (f_equal3 tsubstPat (eq_trans (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (stability_tshift_bind _ _))) (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p21)))) eq_refl (f_equal2 tshiftPat (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p21))) eq_refl)) (tsubst0_tshift0_Pat_reflection_ind p22 (appendHvl k (appendHvl H0 (bind p21))) S1)))
    end.
  ...
  ((substTm (weakenTrace X0 k) s (shiftTm (weakenCutoffTmVar C0 k) s0)) = s0) :=
    match s0 return ((substTm (weakenTrace X0 k) s (shiftTm (weakenCutoffTmVar C0 k) s0)) = s0) with
      ...
      | (Abs T43 t27) => (f_equal2 Abs eq_refl (eq_trans (f_equal3 substTm (weakenTrace_append TmVar X0 k (HS TmVar H0)) eq_refl eq_refl) (subst0_shift0_Tm_reflection_ind t27 (HS TmVar k) s)))
      | (App t28 t29) => (f_equal2 App (subst0_shift0_Tm_reflection_ind t28 k s) (subst0_shift0_Tm_reflection_ind t29 k s))
      | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal3 substTm (weakenTrace_append TmVar X0 k (HS TyVar H0)) eq_refl eq_refl) (subst0_shift0_Tm_reflection_ind t27 (HS TyVar k) s)))
      ...
      | (Case t28 p20 t29) => (f_equal3 Case (subst0_shift0_Tm_reflection_ind t28 k s) eq_refl (eq_trans (f_equal3 substTm (weakenTrace_append TmVar X0 k (appendHvl H0 (bind p20))) eq_refl (f_equal2 shiftTm (weakenCutoffTmVar_append C0 k (appendHvl H0 (bind p20))) eq_refl)) (subst0_shift0_Tm_reflection_ind t29 (appendHvl k (appendHvl H0 (bind p20))) s)))
    end.
  ...
  ((tsubstTm (weakenTrace X0 k) S1 (tshiftTm (weakenCutoffTyVar C0 k) s)) = s) :=
    match s return ((tsubstTm (weakenTrace X0 k) S1 (tshiftTm (weakenCutoffTyVar C0 k) s)) = s) with
      | (Var x13) => eq_refl
      | (Abs T43 t27) => (f_equal2 Abs (tsubst0_tshift0_Ty_reflection_ind T43 k S1) (eq_trans (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (HS TmVar H0)) eq_refl eq_refl) (tsubst0_tshift0_Tm_reflection_ind t27 (HS TmVar k) S1)))
      | (App t28 t29) => (f_equal2 App (tsubst0_tshift0_Tm_reflection_ind t28 k S1) (tsubst0_tshift0_Tm_reflection_ind t29 k S1))
      | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (HS TyVar H0)) eq_refl eq_refl) (tsubst0_tshift0_Tm_reflection_ind t27 (HS TyVar k) S1)))
      ...
      | (Case t28 p20 t29) => (f_equal3 Case (tsubst0_tshift0_Tm_reflection_ind t28 k S1) (tsubst0_tshift0_Pat_reflection_ind p20 k S1) (eq_trans (f_equal3 tsubstTm (eq_trans (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (stability_tshift_bind _ _))) (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p20)))) eq_refl (f_equal2 tshiftTm (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p20))) eq_refl)) (tsubst0_tshift0_Tm_reflection_ind t29 (appendHvl k (appendHvl H0 (bind p20))) S1)))
    end.
...
Section ShiftInteraction.
  Section ShiftIndexCommInd.
    Lemma shiftIndex_shiftIndex0_comm_ind  :
      (forall (k : Hvl) (c0 : (Cutoff TmVar)) (x13 : (Index TmVar)) ,
        ((shiftIndex (weakenCutoffTmVar (CS c0) k) (shiftIndex (weakenCutoffTmVar C0 k) x13)) = (shiftIndex (weakenCutoffTmVar C0 k) (shiftIndex (weakenCutoffTmVar c0 k) x13)))).
    Proof.
      needleGenericShiftIndexCommInd .
    Qed.
    Lemma tshiftIndex_tshiftIndex0_comm_ind  :
      (forall (k : Hvl) (c0 : (Cutoff TyVar)) (X12 : (Index TyVar)) ,
        ((tshiftIndex (weakenCutoffTyVar (CS c0) k) (tshiftIndex (weakenCutoffTyVar C0 k) X12)) = (tshiftIndex (weakenCutoffTyVar C0 k) (tshiftIndex (weakenCutoffTyVar c0 k) X12)))).
    Proof.
      needleGenericShiftIndexCommInd .
    Qed.
  ...
  Section ShiftCommInd.
    ...
    ((tshiftTy (weakenCutoffTyVar (CS c0) k) (tshiftTy (weakenCutoffTyVar C0 k) S1)) = (tshiftTy (weakenCutoffTyVar C0 k) (tshiftTy (weakenCutoffTyVar c0 k) S1))) :=
      match S1 return ((tshiftTy (weakenCutoffTyVar (CS c0) k) (tshiftTy (weakenCutoffTyVar C0 k) S1)) = (tshiftTy (weakenCutoffTyVar C0 k) (tshiftTy (weakenCutoffTyVar c0 k) S1))) with
        ...
        | (TAll T43) => (f_equal TAll (tshift_tshift0_Ty_comm_ind T43 (HS TyVar k) c0))
        | (TProd T44 T45) => (f_equal2 TProd (tshift_tshift0_Ty_comm_ind T44 k c0) (tshift_tshift0_Ty_comm_ind T45 k c0))
      end.
    Fixpoint tshift_tshift0_Pat_comm_ind (p20 : Pat) (k : Hvl) (c0 : (Cutoff TyVar)) {struct p20} :
    ((tshiftPat (weakenCutoffTyVar (CS c0) k) (tshiftPat (weakenCutoffTyVar C0 k) p20)) = (tshiftPat (weakenCutoffTyVar C0 k) (tshiftPat (weakenCutoffTyVar c0 k) p20))) :=
      match p20 return ((tshiftPat (weakenCutoffTyVar (CS c0) k) (tshiftPat (weakenCutoffTyVar C0 k) p20)) = (tshiftPat (weakenCutoffTyVar C0 k) (tshiftPat (weakenCutoffTyVar c0 k) p20))) with
        | (PVar T43) => (f_equal PVar (tshift_tshift0_Ty_comm_ind T43 k c0))
        | (PProd p21 p22) => (f_equal2 PProd (tshift_tshift0_Pat_comm_ind p21 k c0) (eq_trans (f_equal2 tshiftPat (eq_trans (f_equal2 weakenCutoffTyVar eq_refl (f_equal2 appendHvl (eq_refl H0) (stability_tshift_bind _ _))) (weakenCutoffTyVar_append (CS c0) k (appendHvl H0 (bind p21)))) (f_equal2 tshiftPat (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p21))) eq_refl)) (eq_trans (tshift_tshift0_Pat_comm_ind p22 (appendHvl k (appendHvl H0 (bind p21))) c0) (f_equal2 tshiftPat (eq_trans (eq_sym (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p21)))) (f_equal2 weakenCutoffTyVar eq_refl (f_equal2 appendHvl (eq_refl H0) (eq_sym (stability_tshift_bind _ _))))) (f_equal2 tshiftPat (eq_sym (weakenCutoffTyVar_append c0 k (appendHvl H0 (bind p21)))) eq_refl)))))
      end.
    ...
    ((shiftTm (weakenCutoffTmVar (CS c0) k) (shiftTm (weakenCutoffTmVar C0 k) s)) = (shiftTm (weakenCutoffTmVar C0 k) (shiftTm (weakenCutoffTmVar c0 k) s))) :=
      match s return ((shiftTm (weakenCutoffTmVar (CS c0) k) (shiftTm (weakenCutoffTmVar C0 k) s)) = (shiftTm (weakenCutoffTmVar C0 k) (shiftTm (weakenCutoffTmVar c0 k) s))) with
        ...
        | (Abs T43 t27) => (f_equal2 Abs eq_refl (shift_shift0_Tm_comm_ind t27 (HS TmVar k) c0))
        | (App t28 t29) => (f_equal2 App (shift_shift0_Tm_comm_ind t28 k c0) (shift_shift0_Tm_comm_ind t29 k c0))
        | (TAbs t27) => (f_equal TAbs (shift_shift0_Tm_comm_ind t27 (HS TyVar k) c0))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (shift_shift0_Tm_comm_ind t28 k c0) eq_refl (eq_trans (f_equal2 shiftTm (weakenCutoffTmVar_append (CS c0) k (appendHvl H0 (bind p20))) (f_equal2 shiftTm (weakenCutoffTmVar_append C0 k (appendHvl H0 (bind p20))) eq_refl)) (eq_trans (shift_shift0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) c0) (f_equal2 shiftTm (eq_sym (weakenCutoffTmVar_append C0 k (appendHvl H0 (bind p20)))) (f_equal2 shiftTm (eq_sym (weakenCutoffTmVar_append c0 k (appendHvl H0 (bind p20)))) eq_refl)))))
      end.
    ...
    ((shiftTm (weakenCutoffTmVar c0 k) (tshiftTm (weakenCutoffTyVar C0 k) s)) = (tshiftTm (weakenCutoffTyVar C0 k) (shiftTm (weakenCutoffTmVar c0 k) s))) :=
      match s return ((shiftTm (weakenCutoffTmVar c0 k) (tshiftTm (weakenCutoffTyVar C0 k) s)) = (tshiftTm (weakenCutoffTyVar C0 k) (shiftTm (weakenCutoffTmVar c0 k) s))) with
        | (Var x13) => eq_refl
        | (Abs T43 t27) => (f_equal2 Abs eq_refl (shift_tshift0_Tm_comm_ind t27 (HS TmVar k) c0))
        | (App t28 t29) => (f_equal2 App (shift_tshift0_Tm_comm_ind t28 k c0) (shift_tshift0_Tm_comm_ind t29 k c0))
        | (TAbs t27) => (f_equal TAbs (shift_tshift0_Tm_comm_ind t27 (HS TyVar k) c0))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (shift_tshift0_Tm_comm_ind t28 k c0) eq_refl (eq_trans (f_equal2 shiftTm (eq_trans (f_equal2 weakenCutoffTmVar eq_refl (f_equal2 appendHvl (eq_refl H0) (stability_tshift_bind _ _))) (weakenCutoffTmVar_append c0 k (appendHvl H0 (bind p20)))) (f_equal2 tshiftTm (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p20))) eq_refl)) (eq_trans (shift_tshift0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) c0) (f_equal2 tshiftTm (eq_sym (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p20)))) (f_equal2 shiftTm (eq_sym (weakenCutoffTmVar_append c0 k (appendHvl H0 (bind p20)))) eq_refl)))))
      end.
    ...
    ((tshiftTm (weakenCutoffTyVar c0 k) (shiftTm (weakenCutoffTmVar C0 k) s)) = (shiftTm (weakenCutoffTmVar C0 k) (tshiftTm (weakenCutoffTyVar c0 k) s))) :=
      match s return ((tshiftTm (weakenCutoffTyVar c0 k) (shiftTm (weakenCutoffTmVar C0 k) s)) = (shiftTm (weakenCutoffTmVar C0 k) (tshiftTm (weakenCutoffTyVar c0 k) s))) with
        | (Var x13) => eq_refl
        | (Abs T43 t27) => (f_equal2 Abs eq_refl (tshift_shift0_Tm_comm_ind t27 (HS TmVar k) c0))
        | (App t28 t29) => (f_equal2 App (tshift_shift0_Tm_comm_ind t28 k c0) (tshift_shift0_Tm_comm_ind t29 k c0))
        | (TAbs t27) => (f_equal TAbs (tshift_shift0_Tm_comm_ind t27 (HS TyVar k) c0))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (tshift_shift0_Tm_comm_ind t28 k c0) eq_refl (eq_trans (f_equal2 tshiftTm (weakenCutoffTyVar_append c0 k (appendHvl H0 (bind p20))) (f_equal2 shiftTm (weakenCutoffTmVar_append C0 k (appendHvl H0 (bind p20))) eq_refl)) (eq_trans (tshift_shift0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) c0) (f_equal2 shiftTm (eq_trans (eq_sym (weakenCutoffTmVar_append C0 k (appendHvl H0 (bind p20)))) (f_equal2 weakenCutoffTmVar eq_refl (f_equal2 appendHvl (eq_refl H0) (eq_sym (stability_tshift_bind _ _))))) (f_equal2 tshiftTm (eq_sym (weakenCutoffTyVar_append c0 k (appendHvl H0 (bind p20)))) eq_refl)))))
      end.
    ...
    ((tshiftTm (weakenCutoffTyVar (CS c0) k) (tshiftTm (weakenCutoffTyVar C0 k) s)) = (tshiftTm (weakenCutoffTyVar C0 k) (tshiftTm (weakenCutoffTyVar c0 k) s))) :=
      match s return ((tshiftTm (weakenCutoffTyVar (CS c0) k) (tshiftTm (weakenCutoffTyVar C0 k) s)) = (tshiftTm (weakenCutoffTyVar C0 k) (tshiftTm (weakenCutoffTyVar c0 k) s))) with
        | (Var x13) => eq_refl
        | (Abs T43 t27) => (f_equal2 Abs (tshift_tshift0_Ty_comm_ind T43 k c0) (tshift_tshift0_Tm_comm_ind t27 (HS TmVar k) c0))
        | (App t28 t29) => (f_equal2 App (tshift_tshift0_Tm_comm_ind t28 k c0) (tshift_tshift0_Tm_comm_ind t29 k c0))
        | (TAbs t27) => (f_equal TAbs (tshift_tshift0_Tm_comm_ind t27 (HS TyVar k) c0))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (tshift_tshift0_Tm_comm_ind t28 k c0) (tshift_tshift0_Pat_comm_ind p20 k c0) (eq_trans (f_equal2 tshiftTm (eq_trans (f_equal2 weakenCutoffTyVar eq_refl (f_equal2 appendHvl (eq_refl H0) (stability_tshift_bind _ _))) (weakenCutoffTyVar_append (CS c0) k (appendHvl H0 (bind p20)))) (f_equal2 tshiftTm (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p20))) eq_refl)) (eq_trans (tshift_tshift0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) c0) (f_equal2 tshiftTm (eq_trans (eq_sym (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p20)))) (f_equal2 weakenCutoffTyVar eq_refl (f_equal2 appendHvl (eq_refl H0) (eq_sym (stability_tshift_bind _ _))))) (f_equal2 tshiftTm (eq_sym (weakenCutoffTyVar_append c0 k (appendHvl H0 (bind p20)))) eq_refl)))))
      end.
  End ShiftCommInd.
  Section ShiftComm.
    ...
    Definition tshift_tshift0_Pat_comm (p20 : Pat) : (forall (c0 : (Cutoff TyVar)) ,
...
Section WeakenShift.
  ...
  Lemma weakenPat_tshiftPat  :
    (forall (k : Hvl) (c0 : (Cutoff TyVar)) (p20 : Pat) ,
      ((weakenPat (tshiftPat c0 p20) k) = (tshiftPat (weakenCutoffTyVar c0 k) (weakenPat p20 k)))).
  Proof.
    needleGenericWeakenShift .
  Qed.
...
Section ShiftSubstInteraction.
  Section ShiftSubstIndexCommInd.
    Lemma shiftTm_substIndex0_comm_ind (c0 : (Cutoff TmVar)) (s : Tm) :
      (forall (k : Hvl) (x13 : (Index TmVar)) ,
        ((shiftTm (weakenCutoffTmVar c0 k) (substIndex (weakenTrace X0 k) s x13)) = (substIndex (weakenTrace X0 k) (shiftTm c0 s) (shiftIndex (weakenCutoffTmVar (CS c0) k) x13)))).
    Proof.
      needleGenericShiftSubstIndexCommInd .
    Qed.
    Lemma tshiftTm_substIndex0_comm_ind (c0 : (Cutoff TyVar)) (s : Tm) :
      (forall (k : Hvl) (x13 : (Index TmVar)) ,
        ((tshiftTm (weakenCutoffTyVar c0 k) (substIndex (weakenTrace X0 k) s x13)) = (substIndex (weakenTrace X0 k) (tshiftTm c0 s) x13))).
    Proof.
      needleGenericShiftSubstIndexCommInd .
    Qed.
    Lemma tshiftTy_tsubstIndex0_comm_ind (c0 : (Cutoff TyVar)) (S1 : Ty) :
      (forall (k : Hvl) (X12 : (Index TyVar)) ,
        ((tshiftTy (weakenCutoffTyVar c0 k) (tsubstIndex (weakenTrace X0 k) S1 X12)) = (tsubstIndex (weakenTrace X0 k) (tshiftTy c0 S1) (tshiftIndex (weakenCutoffTyVar (CS c0) k) X12)))).
    Proof.
      needleGenericShiftSubstIndexCommInd .
    Qed.
  ...
  Section ShiftSubstCommInd.
    ...
    ((tshiftTy (weakenCutoffTyVar c0 k) (tsubstTy (weakenTrace X0 k) S1 S2)) = (tsubstTy (weakenTrace X0 k) (tshiftTy c0 S1) (tshiftTy (weakenCutoffTyVar (CS c0) k) S2))) :=
      match S2 return ((tshiftTy (weakenCutoffTyVar c0 k) (tsubstTy (weakenTrace X0 k) S1 S2)) = (tsubstTy (weakenTrace X0 k) (tshiftTy c0 S1) (tshiftTy (weakenCutoffTyVar (CS c0) k) S2))) with
        ...
        | (TAll T43) => (f_equal TAll (eq_trans (f_equal2 tshiftTy eq_refl (f_equal3 tsubstTy (weakenTrace_append TyVar X0 k (HS TyVar H0)) eq_refl eq_refl)) (eq_trans (tshift_tsubst0_Ty_comm_ind T43 (HS TyVar k) c0 S1) (f_equal3 tsubstTy (eq_sym (weakenTrace_append TyVar X0 k (HS TyVar H0))) eq_refl eq_refl))))
        | (TProd T44 T45) => (f_equal2 TProd (tshift_tsubst0_Ty_comm_ind T44 k c0 S1) (tshift_tsubst0_Ty_comm_ind T45 k c0 S1))
      end.
    Fixpoint tshift_tsubst0_Pat_comm_ind (p20 : Pat) (k : Hvl) (c0 : (Cutoff TyVar)) (S1 : Ty) {struct p20} :
    ((tshiftPat (weakenCutoffTyVar c0 k) (tsubstPat (weakenTrace X0 k) S1 p20)) = (tsubstPat (weakenTrace X0 k) (tshiftTy c0 S1) (tshiftPat (weakenCutoffTyVar (CS c0) k) p20))) :=
      match p20 return ((tshiftPat (weakenCutoffTyVar c0 k) (tsubstPat (weakenTrace X0 k) S1 p20)) = (tsubstPat (weakenTrace X0 k) (tshiftTy c0 S1) (tshiftPat (weakenCutoffTyVar (CS c0) k) p20))) with
        | (PVar T43) => (f_equal PVar (tshift_tsubst0_Ty_comm_ind T43 k c0 S1))
        | (PProd p21 p22) => (f_equal2 PProd (tshift_tsubst0_Pat_comm_ind p21 k c0 S1) (eq_trans (f_equal2 tshiftPat (eq_trans (f_equal2 weakenCutoffTyVar eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (stability_tsubst_bind _ _ _) (eq_refl H0)))) (weakenCutoffTyVar_append c0 k (appendHvl H0 (bind p21)))) (f_equal3 tsubstPat (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p21))) eq_refl eq_refl)) (eq_trans (tshift_tsubst0_Pat_comm_ind p22 (appendHvl k (appendHvl H0 (bind p21))) c0 S1) (f_equal3 tsubstPat (eq_trans (eq_sym (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p21)))) (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (eq_sym (stability_tshift_bind _ _))))) eq_refl (f_equal2 tshiftPat (eq_sym (weakenCutoffTyVar_append (CS c0) k (appendHvl H0 (bind p21)))) eq_refl)))))
      end.
    ...
    ((shiftTm (weakenCutoffTmVar c0 k) (substTm (weakenTrace X0 k) s s0)) = (substTm (weakenTrace X0 k) (shiftTm c0 s) (shiftTm (weakenCutoffTmVar (CS c0) k) s0))) :=
      match s0 return ((shiftTm (weakenCutoffTmVar c0 k) (substTm (weakenTrace X0 k) s s0)) = (substTm (weakenTrace X0 k) (shiftTm c0 s) (shiftTm (weakenCutoffTmVar (CS c0) k) s0))) with
        ...
        | (Abs T43 t27) => (f_equal2 Abs eq_refl (eq_trans (f_equal2 shiftTm eq_refl (f_equal3 substTm (weakenTrace_append TmVar X0 k (HS TmVar H0)) eq_refl eq_refl)) (eq_trans (shift_subst0_Tm_comm_ind t27 (HS TmVar k) c0 s) (f_equal3 substTm (eq_sym (weakenTrace_append TmVar X0 k (HS TmVar H0))) eq_refl eq_refl))))
        | (App t28 t29) => (f_equal2 App (shift_subst0_Tm_comm_ind t28 k c0 s) (shift_subst0_Tm_comm_ind t29 k c0 s))
        | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal2 shiftTm eq_refl (f_equal3 substTm (weakenTrace_append TmVar X0 k (HS TyVar H0)) eq_refl eq_refl)) (eq_trans (shift_subst0_Tm_comm_ind t27 (HS TyVar k) c0 s) (f_equal3 substTm (eq_sym (weakenTrace_append TmVar X0 k (HS TyVar H0))) eq_refl eq_refl))))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (shift_subst0_Tm_comm_ind t28 k c0 s) eq_refl (eq_trans (f_equal2 shiftTm (weakenCutoffTmVar_append c0 k (appendHvl H0 (bind p20))) (f_equal3 substTm (weakenTrace_append TmVar X0 k (appendHvl H0 (bind p20))) eq_refl eq_refl)) (eq_trans (shift_subst0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) c0 s) (f_equal3 substTm (eq_sym (weakenTrace_append TmVar X0 k (appendHvl H0 (bind p20)))) eq_refl (f_equal2 shiftTm (eq_sym (weakenCutoffTmVar_append (CS c0) k (appendHvl H0 (bind p20)))) eq_refl)))))
      end.
    ...
    ((shiftTm (weakenCutoffTmVar c0 k) (tsubstTm (weakenTrace X0 k) S1 s)) = (tsubstTm (weakenTrace X0 k) S1 (shiftTm (weakenCutoffTmVar c0 k) s))) :=
      match s return ((shiftTm (weakenCutoffTmVar c0 k) (tsubstTm (weakenTrace X0 k) S1 s)) = (tsubstTm (weakenTrace X0 k) S1 (shiftTm (weakenCutoffTmVar c0 k) s))) with
        | (Var x13) => eq_refl
        | (Abs T43 t27) => (f_equal2 Abs eq_refl (eq_trans (f_equal2 shiftTm eq_refl (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (HS TmVar H0)) eq_refl eq_refl)) (eq_trans (shift_tsubst0_Tm_comm_ind t27 (HS TmVar k) c0 S1) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar X0 k (HS TmVar H0))) eq_refl eq_refl))))
        | (App t28 t29) => (f_equal2 App (shift_tsubst0_Tm_comm_ind t28 k c0 S1) (shift_tsubst0_Tm_comm_ind t29 k c0 S1))
        | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal2 shiftTm eq_refl (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (HS TyVar H0)) eq_refl eq_refl)) (eq_trans (shift_tsubst0_Tm_comm_ind t27 (HS TyVar k) c0 S1) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar X0 k (HS TyVar H0))) eq_refl eq_refl))))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (shift_tsubst0_Tm_comm_ind t28 k c0 S1) eq_refl (eq_trans (f_equal2 shiftTm (eq_trans (f_equal2 weakenCutoffTmVar eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (stability_tsubst_bind _ _ _) (eq_refl H0)))) (weakenCutoffTmVar_append c0 k (appendHvl H0 (bind p20)))) (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p20))) eq_refl eq_refl)) (eq_trans (shift_tsubst0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) c0 S1) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p20)))) eq_refl (f_equal2 shiftTm (eq_sym (weakenCutoffTmVar_append c0 k (appendHvl H0 (bind p20)))) eq_refl)))))
      end.
    ...
    ((tshiftTm (weakenCutoffTyVar c0 k) (substTm (weakenTrace X0 k) s s0)) = (substTm (weakenTrace X0 k) (tshiftTm c0 s) (tshiftTm (weakenCutoffTyVar c0 k) s0))) :=
      match s0 return ((tshiftTm (weakenCutoffTyVar c0 k) (substTm (weakenTrace X0 k) s s0)) = (substTm (weakenTrace X0 k) (tshiftTm c0 s) (tshiftTm (weakenCutoffTyVar c0 k) s0))) with
        ...
        | (Abs T43 t27) => (f_equal2 Abs eq_refl (eq_trans (f_equal2 tshiftTm eq_refl (f_equal3 substTm (weakenTrace_append TmVar X0 k (HS TmVar H0)) eq_refl eq_refl)) (eq_trans (tshift_subst0_Tm_comm_ind t27 (HS TmVar k) c0 s) (f_equal3 substTm (eq_sym (weakenTrace_append TmVar X0 k (HS TmVar H0))) eq_refl eq_refl))))
        | (App t28 t29) => (f_equal2 App (tshift_subst0_Tm_comm_ind t28 k c0 s) (tshift_subst0_Tm_comm_ind t29 k c0 s))
        | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal2 tshiftTm eq_refl (f_equal3 substTm (weakenTrace_append TmVar X0 k (HS TyVar H0)) eq_refl eq_refl)) (eq_trans (tshift_subst0_Tm_comm_ind t27 (HS TyVar k) c0 s) (f_equal3 substTm (eq_sym (weakenTrace_append TmVar X0 k (HS TyVar H0))) eq_refl eq_refl))))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (tshift_subst0_Tm_comm_ind t28 k c0 s) eq_refl (eq_trans (f_equal2 tshiftTm (weakenCutoffTyVar_append c0 k (appendHvl H0 (bind p20))) (f_equal3 substTm (weakenTrace_append TmVar X0 k (appendHvl H0 (bind p20))) eq_refl eq_refl)) (eq_trans (tshift_subst0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) c0 s) (f_equal3 substTm (eq_trans (eq_sym (weakenTrace_append TmVar X0 k (appendHvl H0 (bind p20)))) (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (eq_sym (stability_tshift_bind _ _))))) eq_refl (f_equal2 tshiftTm (eq_sym (weakenCutoffTyVar_append c0 k (appendHvl H0 (bind p20)))) eq_refl)))))
      end.
    ...
    ((tshiftTm (weakenCutoffTyVar c0 k) (tsubstTm (weakenTrace X0 k) S1 s)) = (tsubstTm (weakenTrace X0 k) (tshiftTy c0 S1) (tshiftTm (weakenCutoffTyVar (CS c0) k) s))) :=
      match s return ((tshiftTm (weakenCutoffTyVar c0 k) (tsubstTm (weakenTrace X0 k) S1 s)) = (tsubstTm (weakenTrace X0 k) (tshiftTy c0 S1) (tshiftTm (weakenCutoffTyVar (CS c0) k) s))) with
        | (Var x13) => eq_refl
        | (Abs T43 t27) => (f_equal2 Abs (tshift_tsubst0_Ty_comm_ind T43 k c0 S1) (eq_trans (f_equal2 tshiftTm eq_refl (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (HS TmVar H0)) eq_refl eq_refl)) (eq_trans (tshift_tsubst0_Tm_comm_ind t27 (HS TmVar k) c0 S1) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar X0 k (HS TmVar H0))) eq_refl eq_refl))))
        | (App t28 t29) => (f_equal2 App (tshift_tsubst0_Tm_comm_ind t28 k c0 S1) (tshift_tsubst0_Tm_comm_ind t29 k c0 S1))
        | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal2 tshiftTm eq_refl (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (HS TyVar H0)) eq_refl eq_refl)) (eq_trans (tshift_tsubst0_Tm_comm_ind t27 (HS TyVar k) c0 S1) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar X0 k (HS TyVar H0))) eq_refl eq_refl))))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (tshift_tsubst0_Tm_comm_ind t28 k c0 S1) (tshift_tsubst0_Pat_comm_ind p20 k c0 S1) (eq_trans (f_equal2 tshiftTm (eq_trans (f_equal2 weakenCutoffTyVar eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (stability_tsubst_bind _ _ _) (eq_refl H0)))) (weakenCutoffTyVar_append c0 k (appendHvl H0 (bind p20)))) (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p20))) eq_refl eq_refl)) (eq_trans (tshift_tsubst0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) c0 S1) (f_equal3 tsubstTm (eq_trans (eq_sym (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p20)))) (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (eq_sym (stability_tshift_bind _ _))))) eq_refl (f_equal2 tshiftTm (eq_sym (weakenCutoffTyVar_append (CS c0) k (appendHvl H0 (bind p20)))) eq_refl)))))
      end.
  ...
  Section ShiftSubstComm.
    ...
    Definition tshiftPat_tsubstPat0_comm (p20 : Pat) : (forall (c0 : (Cutoff TyVar)) (S1 : Ty) ,
  ...
  Section SubstShiftIndexCommInd.
    Lemma substIndex_shiftTm0_comm_ind (d0 : (Trace TmVar)) (s : Tm) :
      (forall (k : Hvl) (x13 : (Index TmVar)) ,
        ((substIndex (weakenTrace (XS TmVar d0) k) s (shiftIndex (weakenCutoffTmVar C0 k) x13)) = (shiftTm (weakenCutoffTmVar C0 k) (substIndex (weakenTrace d0 k) s x13)))).
    Proof.
      needleGenericShiftSubstIndexCommInd .
    Qed.
    Lemma substIndex_tshiftTm0_comm_ind (d0 : (Trace TmVar)) (s : Tm) :
      (forall (k : Hvl) (x13 : (Index TmVar)) ,
        ((substIndex (weakenTrace (XS TyVar d0) k) s x13) = (tshiftTm (weakenCutoffTyVar C0 k) (substIndex (weakenTrace d0 k) s x13)))).
    Proof.
      needleGenericShiftSubstIndexCommInd .
    Qed.
    Lemma tsubstIndex_shiftTy0_comm_ind (d0 : (Trace TyVar)) (S1 : Ty) :
      (forall (k : Hvl) (X12 : (Index TyVar)) ,
        ((tsubstIndex (weakenTrace (XS TmVar d0) k) S1 X12) = (tsubstIndex (weakenTrace d0 k) S1 X12))).
    Proof.
      needleGenericShiftSubstIndexCommInd .
    Qed.
    Lemma tsubstIndex_tshiftTy0_comm_ind (d0 : (Trace TyVar)) (S1 : Ty) :
      (forall (k : Hvl) (X12 : (Index TyVar)) ,
        ((tsubstIndex (weakenTrace (XS TyVar d0) k) S1 (tshiftIndex (weakenCutoffTyVar C0 k) X12)) = (tshiftTy (weakenCutoffTyVar C0 k) (tsubstIndex (weakenTrace d0 k) S1 X12)))).
    Proof.
      needleGenericShiftSubstIndexCommInd .
    Qed.
  ...
  Section SubstShiftCommInd.
    ...
    ((tsubstTy (weakenTrace (XS TyVar d0) k) S1 (tshiftTy (weakenCutoffTyVar C0 k) S2)) = (tshiftTy (weakenCutoffTyVar C0 k) (tsubstTy (weakenTrace d0 k) S1 S2))) :=
      match S2 return ((tsubstTy (weakenTrace (XS TyVar d0) k) S1 (tshiftTy (weakenCutoffTyVar C0 k) S2)) = (tshiftTy (weakenCutoffTyVar C0 k) (tsubstTy (weakenTrace d0 k) S1 S2))) with
        ...
        | (TAll T43) => (f_equal TAll (eq_trans (f_equal3 tsubstTy (weakenTrace_append TyVar (XS TyVar d0) k (HS TyVar H0)) eq_refl eq_refl) (eq_trans (tsubst_tshift0_Ty_comm_ind T43 (HS TyVar k) d0 S1) (f_equal2 tshiftTy eq_refl (f_equal3 tsubstTy (eq_sym (weakenTrace_append TyVar d0 k (HS TyVar H0))) eq_refl eq_refl)))))
        | (TProd T44 T45) => (f_equal2 TProd (tsubst_tshift0_Ty_comm_ind T44 k d0 S1) (tsubst_tshift0_Ty_comm_ind T45 k d0 S1))
      end.
    Fixpoint tsubst_tshift0_Pat_comm_ind (p20 : Pat) (k : Hvl) (d0 : (Trace TyVar)) (S1 : Ty) {struct p20} :
    ((tsubstPat (weakenTrace (XS TyVar d0) k) S1 (tshiftPat (weakenCutoffTyVar C0 k) p20)) = (tshiftPat (weakenCutoffTyVar C0 k) (tsubstPat (weakenTrace d0 k) S1 p20))) :=
      match p20 return ((tsubstPat (weakenTrace (XS TyVar d0) k) S1 (tshiftPat (weakenCutoffTyVar C0 k) p20)) = (tshiftPat (weakenCutoffTyVar C0 k) (tsubstPat (weakenTrace d0 k) S1 p20))) with
        | (PVar T43) => (f_equal PVar (tsubst_tshift0_Ty_comm_ind T43 k d0 S1))
        | (PProd p21 p22) => (f_equal2 PProd (tsubst_tshift0_Pat_comm_ind p21 k d0 S1) (eq_trans (f_equal3 tsubstPat (eq_trans (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (stability_tshift_bind _ _))) (weakenTrace_append TyVar (XS TyVar d0) k (appendHvl H0 (bind p21)))) eq_refl (f_equal2 tshiftPat (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p21))) eq_refl)) (eq_trans (tsubst_tshift0_Pat_comm_ind p22 (appendHvl k (appendHvl H0 (bind p21))) d0 S1) (f_equal2 tshiftPat (eq_trans (eq_sym (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p21)))) (f_equal2 weakenCutoffTyVar eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (eq_sym (stability_tsubst_bind _ _ _)) (eq_refl H0))))) (f_equal3 tsubstPat (eq_sym (weakenTrace_append TyVar d0 k (appendHvl H0 (bind p21)))) eq_refl eq_refl)))))
      end.
    ...
    ((substTm (weakenTrace (XS TmVar d0) k) s (shiftTm (weakenCutoffTmVar C0 k) s0)) = (shiftTm (weakenCutoffTmVar C0 k) (substTm (weakenTrace d0 k) s s0))) :=
      match s0 return ((substTm (weakenTrace (XS TmVar d0) k) s (shiftTm (weakenCutoffTmVar C0 k) s0)) = (shiftTm (weakenCutoffTmVar C0 k) (substTm (weakenTrace d0 k) s s0))) with
        ...
        | (Abs T43 t27) => (f_equal2 Abs eq_refl (eq_trans (f_equal3 substTm (weakenTrace_append TmVar (XS TmVar d0) k (HS TmVar H0)) eq_refl eq_refl) (eq_trans (subst_shift0_Tm_comm_ind t27 (HS TmVar k) d0 s) (f_equal2 shiftTm eq_refl (f_equal3 substTm (eq_sym (weakenTrace_append TmVar d0 k (HS TmVar H0))) eq_refl eq_refl)))))
        | (App t28 t29) => (f_equal2 App (subst_shift0_Tm_comm_ind t28 k d0 s) (subst_shift0_Tm_comm_ind t29 k d0 s))
        | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal3 substTm (weakenTrace_append TmVar (XS TmVar d0) k (HS TyVar H0)) eq_refl eq_refl) (eq_trans (subst_shift0_Tm_comm_ind t27 (HS TyVar k) d0 s) (f_equal2 shiftTm eq_refl (f_equal3 substTm (eq_sym (weakenTrace_append TmVar d0 k (HS TyVar H0))) eq_refl eq_refl)))))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (subst_shift0_Tm_comm_ind t28 k d0 s) eq_refl (eq_trans (f_equal3 substTm (weakenTrace_append TmVar (XS TmVar d0) k (appendHvl H0 (bind p20))) eq_refl (f_equal2 shiftTm (weakenCutoffTmVar_append C0 k (appendHvl H0 (bind p20))) eq_refl)) (eq_trans (subst_shift0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) d0 s) (f_equal2 shiftTm (eq_sym (weakenCutoffTmVar_append C0 k (appendHvl H0 (bind p20)))) (f_equal3 substTm (eq_sym (weakenTrace_append TmVar d0 k (appendHvl H0 (bind p20)))) eq_refl eq_refl)))))
      end.
    ...
    ((substTm (weakenTrace (XS TyVar d0) k) s (tshiftTm (weakenCutoffTyVar C0 k) s0)) = (tshiftTm (weakenCutoffTyVar C0 k) (substTm (weakenTrace d0 k) s s0))) :=
      match s0 return ((substTm (weakenTrace (XS TyVar d0) k) s (tshiftTm (weakenCutoffTyVar C0 k) s0)) = (tshiftTm (weakenCutoffTyVar C0 k) (substTm (weakenTrace d0 k) s s0))) with
        ...
        | (Abs T43 t27) => (f_equal2 Abs eq_refl (eq_trans (f_equal3 substTm (weakenTrace_append TmVar (XS TyVar d0) k (HS TmVar H0)) eq_refl eq_refl) (eq_trans (subst_tshift0_Tm_comm_ind t27 (HS TmVar k) d0 s) (f_equal2 tshiftTm eq_refl (f_equal3 substTm (eq_sym (weakenTrace_append TmVar d0 k (HS TmVar H0))) eq_refl eq_refl)))))
        | (App t28 t29) => (f_equal2 App (subst_tshift0_Tm_comm_ind t28 k d0 s) (subst_tshift0_Tm_comm_ind t29 k d0 s))
        | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal3 substTm (weakenTrace_append TmVar (XS TyVar d0) k (HS TyVar H0)) eq_refl eq_refl) (eq_trans (subst_tshift0_Tm_comm_ind t27 (HS TyVar k) d0 s) (f_equal2 tshiftTm eq_refl (f_equal3 substTm (eq_sym (weakenTrace_append TmVar d0 k (HS TyVar H0))) eq_refl eq_refl)))))
    ...
    ((tsubstTm (weakenTrace d0 k) S1 (shiftTm (weakenCutoffTmVar C0 k) s)) = (shiftTm (weakenCutoffTmVar C0 k) (tsubstTm (weakenTrace d0 k) S1 s))) :=
      match s return ((tsubstTm (weakenTrace d0 k) S1 (shiftTm (weakenCutoffTmVar C0 k) s)) = (shiftTm (weakenCutoffTmVar C0 k) (tsubstTm (weakenTrace d0 k) S1 s))) with
        | (Var x13) => eq_refl
        | (Abs T43 t27) => (f_equal2 Abs eq_refl (eq_trans (f_equal3 tsubstTm (weakenTrace_append TyVar d0 k (HS TmVar H0)) eq_refl eq_refl) (eq_trans (tsubst_shift0_Tm_comm_ind t27 (HS TmVar k) d0 S1) (f_equal2 shiftTm eq_refl (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar d0 k (HS TmVar H0))) eq_refl eq_refl)))))
        | (App t28 t29) => (f_equal2 App (tsubst_shift0_Tm_comm_ind t28 k d0 S1) (tsubst_shift0_Tm_comm_ind t29 k d0 S1))
        | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal3 tsubstTm (weakenTrace_append TyVar d0 k (HS TyVar H0)) eq_refl eq_refl) (eq_trans (tsubst_shift0_Tm_comm_ind t27 (HS TyVar k) d0 S1) (f_equal2 shiftTm eq_refl (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar d0 k (HS TyVar H0))) eq_refl eq_refl)))))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (tsubst_shift0_Tm_comm_ind t28 k d0 S1) eq_refl (eq_trans (f_equal3 tsubstTm (weakenTrace_append TyVar d0 k (appendHvl H0 (bind p20))) eq_refl (f_equal2 shiftTm (weakenCutoffTmVar_append C0 k (appendHvl H0 (bind p20))) eq_refl)) (eq_trans (tsubst_shift0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) d0 S1) (f_equal2 shiftTm (eq_trans (eq_sym (weakenCutoffTmVar_append C0 k (appendHvl H0 (bind p20)))) (f_equal2 weakenCutoffTmVar eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (eq_sym (stability_tsubst_bind _ _ _)) (eq_refl H0))))) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar d0 k (appendHvl H0 (bind p20)))) eq_refl eq_refl)))))
      end.
    ...
    ((tsubstTm (weakenTrace (XS TyVar d0) k) S1 (tshiftTm (weakenCutoffTyVar C0 k) s)) = (tshiftTm (weakenCutoffTyVar C0 k) (tsubstTm (weakenTrace d0 k) S1 s))) :=
      match s return ((tsubstTm (weakenTrace (XS TyVar d0) k) S1 (tshiftTm (weakenCutoffTyVar C0 k) s)) = (tshiftTm (weakenCutoffTyVar C0 k) (tsubstTm (weakenTrace d0 k) S1 s))) with
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (tsubst_tshift0_Tm_comm_ind t28 k d0 S1) (tsubst_tshift0_Pat_comm_ind p20 k d0 S1) (eq_trans (f_equal3 tsubstTm (eq_trans (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (stability_tshift_bind _ _))) (weakenTrace_append TyVar (XS TyVar d0) k (appendHvl H0 (bind p20)))) eq_refl (f_equal2 tshiftTm (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p20))) eq_refl)) (eq_trans (tsubst_tshift0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) d0 S1) (f_equal2 tshiftTm (eq_trans (eq_sym (weakenCutoffTyVar_append C0 k (appendHvl H0 (bind p20)))) (f_equal2 weakenCutoffTyVar eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (eq_sym (stability_tsubst_bind _ _ _)) (eq_refl H0))))) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar d0 k (appendHvl H0 (bind p20)))) eq_refl eq_refl)))))
      end.
  ...
  Section SubstShiftComm.
    ...
    Definition tsubstPat_tshiftPat0_comm (p20 : Pat) : (forall (d0 : (Trace TyVar)) (S1 : Ty) ,
      ((tsubstPat (XS TyVar d0) S1 (tshiftPat C0 p20)) = (tshiftPat C0 (tsubstPat d0 S1 p20)))) := (tsubst_tshift0_Pat_comm_ind p20 H0).
  ...
  Section SubstSubordInd.
    ...
    ((tsubstTy (weakenTrace (XS TmVar d0) k) S1 S2) = (tsubstTy (weakenTrace d0 k) S1 S2)) :=
      match S2 return ((tsubstTy (weakenTrace (XS TmVar d0) k) S1 S2) = (tsubstTy (weakenTrace d0 k) S1 S2)) with
        ...
        | (TArr T44 T45) => (f_equal2 TArr (tsubst_TmVar_Ty_ind T44 k d0 S1) (tsubst_TmVar_Ty_ind T45 k d0 S1))
        | (TAll T43) => (f_equal TAll (eq_trans (f_equal3 tsubstTy (weakenTrace_append TyVar (XS TmVar d0) k (HS TyVar H0)) eq_refl eq_refl) (eq_trans (tsubst_TmVar_Ty_ind T43 (HS TyVar k) d0 S1) (f_equal3 tsubstTy (eq_sym (weakenTrace_append TyVar d0 k (HS TyVar H0))) eq_refl eq_refl))))
        | (TProd T44 T45) => (f_equal2 TProd (tsubst_TmVar_Ty_ind T44 k d0 S1) (tsubst_TmVar_Ty_ind T45 k d0 S1))
      end.
    Fixpoint tsubst_TmVar_Pat_ind (p20 : Pat) (k : Hvl) (d0 : (Trace TyVar)) (S1 : Ty) {struct p20} :
    ((tsubstPat (weakenTrace (XS TmVar d0) k) S1 p20) = (tsubstPat (weakenTrace d0 k) S1 p20)) :=
      match p20 return ((tsubstPat (weakenTrace (XS TmVar d0) k) S1 p20) = (tsubstPat (weakenTrace d0 k) S1 p20)) with
        | (PVar T43) => (f_equal PVar (tsubst_TmVar_Ty_ind T43 k d0 S1))
        | (PProd p21 p22) => (f_equal2 PProd (tsubst_TmVar_Pat_ind p21 k d0 S1) (eq_trans (f_equal3 tsubstPat (weakenTrace_append TyVar (XS TmVar d0) k (appendHvl H0 (bind p21))) eq_refl eq_refl) (eq_trans (tsubst_TmVar_Pat_ind p22 (appendHvl k (appendHvl H0 (bind p21))) d0 S1) (f_equal3 tsubstPat (eq_sym (weakenTrace_append TyVar d0 k (appendHvl H0 (bind p21)))) eq_refl eq_refl))))
      end.
    ...
    ((tsubstTm (weakenTrace (XS TmVar d0) k) S1 s) = (tsubstTm (weakenTrace d0 k) S1 s)) :=
      match s return ((tsubstTm (weakenTrace (XS TmVar d0) k) S1 s) = (tsubstTm (weakenTrace d0 k) S1 s)) with
        | (Var x13) => eq_refl
        | (Abs T43 t27) => (f_equal2 Abs (tsubst_TmVar_Ty_ind T43 k d0 S1) (eq_trans (f_equal3 tsubstTm (weakenTrace_append TyVar (XS TmVar d0) k (HS TmVar H0)) eq_refl eq_refl) (eq_trans (tsubst_TmVar_Tm_ind t27 (HS TmVar k) d0 S1) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar d0 k (HS TmVar H0))) eq_refl eq_refl))))
        | (App t28 t29) => (f_equal2 App (tsubst_TmVar_Tm_ind t28 k d0 S1) (tsubst_TmVar_Tm_ind t29 k d0 S1))
        | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal3 tsubstTm (weakenTrace_append TyVar (XS TmVar d0) k (HS TyVar H0)) eq_refl eq_refl) (eq_trans (tsubst_TmVar_Tm_ind t27 (HS TyVar k) d0 S1) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar d0 k (HS TyVar H0))) eq_refl eq_refl))))
        | (TApp t27 T43) => (f_equal2 TApp (tsubst_TmVar_Tm_ind t27 k d0 S1) (tsubst_TmVar_Ty_ind T43 k d0 S1))
        | (Prod t28 t29) => (f_equal2 Prod (tsubst_TmVar_Tm_ind t28 k d0 S1) (tsubst_TmVar_Tm_ind t29 k d0 S1))
        | (Case t28 p20 t29) => (f_equal3 Case (tsubst_TmVar_Tm_ind t28 k d0 S1) (tsubst_TmVar_Pat_ind p20 k d0 S1) (eq_trans (f_equal3 tsubstTm (weakenTrace_append TyVar (XS TmVar d0) k (appendHvl H0 (bind p20))) eq_refl eq_refl) (eq_trans (tsubst_TmVar_Tm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) d0 S1) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar d0 k (appendHvl H0 (bind p20)))) eq_refl eq_refl))))
      end.
  End SubstSubordInd.
  Section SubstSubord.
    ...
    Definition tsubstPat_TmVar (p20 : Pat) : (forall (d0 : (Trace TyVar)) (S1 : Ty) ,
      ((tsubstPat (XS TmVar d0) S1 p20) = (tsubstPat d0 S1 p20))) := (tsubst_TmVar_Pat_ind p20 H0).
...
Section SubstSubstInteraction.
  Section SubstSubstIndexCommInd.
    Lemma substTm_substIndex0_commright_ind (d0 : (Trace TmVar)) (s : Tm) (s0 : Tm) :
      (forall (k : Hvl) (x13 : (Index TmVar)) ,
        ((substTm (weakenTrace d0 k) s (substIndex (weakenTrace X0 k) s0 x13)) = (substTm (weakenTrace X0 k) (substTm d0 s s0) (substIndex (weakenTrace (XS TmVar d0) k) s x13)))).
    Proof.
    ...
    Lemma tsubstTy_tsubstIndex0_commright_ind (d0 : (Trace TyVar)) (S1 : Ty) (S2 : Ty) :
      (forall (k : Hvl) (X12 : (Index TyVar)) ,
        ((tsubstTy (weakenTrace d0 k) S1 (tsubstIndex (weakenTrace X0 k) S2 X12)) = (tsubstTy (weakenTrace X0 k) (tsubstTy d0 S1 S2) (tsubstIndex (weakenTrace (XS TyVar d0) k) S1 X12)))).
    Proof.
      needleGenericSubstSubstIndexCommInd .
    Qed.
    Lemma substTy_tsubstIndex0_commleft_ind (d0 : (Trace TmVar)) (s : Tm) (S1 : Ty) :
      (forall (k : Hvl) (x13 : (Index TmVar)) ,
        ((substIndex (weakenTrace d0 k) s x13) = (tsubstTm (weakenTrace X0 k) S1 (substIndex (weakenTrace (XS TyVar d0) k) s x13)))).
    Proof.
      needleGenericSubstSubstIndexCommInd .
    Qed.
  ...
  Section SubstSubstCommInd.
    ...
    ((tsubstTy (weakenTrace d0 k) S1 (tsubstTy (weakenTrace X0 k) S2 S3)) = (tsubstTy (weakenTrace X0 k) (tsubstTy d0 S1 S2) (tsubstTy (weakenTrace (XS TyVar d0) k) S1 S3))) :=
      match S3 return ((tsubstTy (weakenTrace d0 k) S1 (tsubstTy (weakenTrace X0 k) S2 S3)) = (tsubstTy (weakenTrace X0 k) (tsubstTy d0 S1 S2) (tsubstTy (weakenTrace (XS TyVar d0) k) S1 S3))) with
        ...
        | (TAll T43) => (f_equal TAll (eq_trans (f_equal3 tsubstTy (weakenTrace_append TyVar d0 k (HS TyVar H0)) eq_refl (f_equal3 tsubstTy (weakenTrace_append TyVar X0 k (HS TyVar H0)) eq_refl eq_refl)) (eq_trans (tsubst_tsubst0_Ty_comm_ind T43 (HS TyVar k) d0 S1 S2) (f_equal3 tsubstTy (eq_sym (weakenTrace_append TyVar X0 k (HS TyVar H0))) eq_refl (f_equal3 tsubstTy (eq_sym (weakenTrace_append TyVar (XS TyVar d0) k (HS TyVar H0))) eq_refl eq_refl)))))
        | (TProd T44 T45) => (f_equal2 TProd (tsubst_tsubst0_Ty_comm_ind T44 k d0 S1 S2) (tsubst_tsubst0_Ty_comm_ind T45 k d0 S1 S2))
      end.
    Fixpoint tsubst_tsubst0_Pat_comm_ind (p20 : Pat) (k : Hvl) (d0 : (Trace TyVar)) (S1 : Ty) (S2 : Ty) {struct p20} :
    ((tsubstPat (weakenTrace d0 k) S1 (tsubstPat (weakenTrace X0 k) S2 p20)) = (tsubstPat (weakenTrace X0 k) (tsubstTy d0 S1 S2) (tsubstPat (weakenTrace (XS TyVar d0) k) S1 p20))) :=
      match p20 return ((tsubstPat (weakenTrace d0 k) S1 (tsubstPat (weakenTrace X0 k) S2 p20)) = (tsubstPat (weakenTrace X0 k) (tsubstTy d0 S1 S2) (tsubstPat (weakenTrace (XS TyVar d0) k) S1 p20))) with
        | (PVar T43) => (f_equal PVar (tsubst_tsubst0_Ty_comm_ind T43 k d0 S1 S2))
        | (PProd p21 p22) => (f_equal2 PProd (tsubst_tsubst0_Pat_comm_ind p21 k d0 S1 S2) (eq_trans (f_equal3 tsubstPat (eq_trans (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (stability_tsubst_bind _ _ _) (eq_refl H0)))) (weakenTrace_append TyVar d0 k (appendHvl H0 (bind p21)))) eq_refl (f_equal3 tsubstPat (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p21))) eq_refl eq_refl)) (eq_trans (tsubst_tsubst0_Pat_comm_ind p22 (appendHvl k (appendHvl H0 (bind p21))) d0 S1 S2) (f_equal3 tsubstPat (eq_trans (eq_sym (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p21)))) (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (eq_sym (stability_tsubst_bind _ _ _)) (eq_refl H0))))) eq_refl (f_equal3 tsubstPat (eq_sym (weakenTrace_append TyVar (XS TyVar d0) k (appendHvl H0 (bind p21)))) eq_refl eq_refl)))))
      end.
    ...
    ((substTm (weakenTrace d0 k) s (substTm (weakenTrace X0 k) s0 s1)) = (substTm (weakenTrace X0 k) (substTm d0 s s0) (substTm (weakenTrace (XS TmVar d0) k) s s1))) :=
      match s1 return ((substTm (weakenTrace d0 k) s (substTm (weakenTrace X0 k) s0 s1)) = (substTm (weakenTrace X0 k) (substTm d0 s s0) (substTm (weakenTrace (XS TmVar d0) k) s s1))) with
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (subst_subst0_Tm_comm_ind t28 k d0 s s0) eq_refl (eq_trans (f_equal3 substTm (weakenTrace_append TmVar d0 k (appendHvl H0 (bind p20))) eq_refl (f_equal3 substTm (weakenTrace_append TmVar X0 k (appendHvl H0 (bind p20))) eq_refl eq_refl)) (eq_trans (subst_subst0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) d0 s s0) (f_equal3 substTm (eq_sym (weakenTrace_append TmVar X0 k (appendHvl H0 (bind p20)))) eq_refl (f_equal3 substTm (eq_sym (weakenTrace_append TmVar (XS TmVar d0) k (appendHvl H0 (bind p20)))) eq_refl eq_refl)))))
      end.
    ...
    ((substTm (weakenTrace d0 k) s (tsubstTm (weakenTrace X0 k) S1 s0)) = (tsubstTm (weakenTrace X0 k) S1 (substTm (weakenTrace (XS TyVar d0) k) s s0))) :=
      match s0 return ((substTm (weakenTrace d0 k) s (tsubstTm (weakenTrace X0 k) S1 s0)) = (tsubstTm (weakenTrace X0 k) S1 (substTm (weakenTrace (XS TyVar d0) k) s s0))) with
        ...
        | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal3 substTm (weakenTrace_append TmVar d0 k (HS TyVar H0)) eq_refl (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (HS TyVar H0)) eq_refl eq_refl)) (eq_trans (subst_tsubst0_Tm_comm_ind t27 (HS TyVar k) d0 s S1) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar X0 k (HS TyVar H0))) eq_refl (f_equal3 substTm (eq_sym (weakenTrace_append TmVar (XS TyVar d0) k (HS TyVar H0))) eq_refl eq_refl)))))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (subst_tsubst0_Tm_comm_ind t28 k d0 s S1) eq_refl (eq_trans (f_equal3 substTm (eq_trans (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (stability_tsubst_bind _ _ _) (eq_refl H0)))) (weakenTrace_append TmVar d0 k (appendHvl H0 (bind p20)))) eq_refl (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p20))) eq_refl eq_refl)) (eq_trans (subst_tsubst0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) d0 s S1) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p20)))) eq_refl (f_equal3 substTm (eq_sym (weakenTrace_append TmVar (XS TyVar d0) k (appendHvl H0 (bind p20)))) eq_refl eq_refl)))))
      end.
    ...
    ((tsubstTm (weakenTrace d0 k) S1 (substTm (weakenTrace X0 k) s s0)) = (substTm (weakenTrace X0 k) (tsubstTm d0 S1 s) (tsubstTm (weakenTrace d0 k) S1 s0))) :=
      match s0 return ((tsubstTm (weakenTrace d0 k) S1 (substTm (weakenTrace X0 k) s s0)) = (substTm (weakenTrace X0 k) (tsubstTm d0 S1 s) (tsubstTm (weakenTrace d0 k) S1 s0))) with
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (tsubst_subst0_Tm_comm_ind t28 k d0 S1 s) eq_refl (eq_trans (f_equal3 tsubstTm (weakenTrace_append TyVar d0 k (appendHvl H0 (bind p20))) eq_refl (f_equal3 substTm (weakenTrace_append TmVar X0 k (appendHvl H0 (bind p20))) eq_refl eq_refl)) (eq_trans (tsubst_subst0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) d0 S1 s) (f_equal3 substTm (eq_trans (eq_sym (weakenTrace_append TmVar X0 k (appendHvl H0 (bind p20)))) (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (eq_sym (stability_tsubst_bind _ _ _)) (eq_refl H0))))) eq_refl (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar d0 k (appendHvl H0 (bind p20)))) eq_refl eq_refl)))))
      end.
    ...
    ((tsubstTm (weakenTrace d0 k) S1 (tsubstTm (weakenTrace X0 k) S2 s)) = (tsubstTm (weakenTrace X0 k) (tsubstTy d0 S1 S2) (tsubstTm (weakenTrace (XS TyVar d0) k) S1 s))) :=
      match s return ((tsubstTm (weakenTrace d0 k) S1 (tsubstTm (weakenTrace X0 k) S2 s)) = (tsubstTm (weakenTrace X0 k) (tsubstTy d0 S1 S2) (tsubstTm (weakenTrace (XS TyVar d0) k) S1 s))) with
        ...
        | (TAbs t27) => (f_equal TAbs (eq_trans (f_equal3 tsubstTm (weakenTrace_append TyVar d0 k (HS TyVar H0)) eq_refl (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (HS TyVar H0)) eq_refl eq_refl)) (eq_trans (tsubst_tsubst0_Tm_comm_ind t27 (HS TyVar k) d0 S1 S2) (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar X0 k (HS TyVar H0))) eq_refl (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar (XS TyVar d0) k (HS TyVar H0))) eq_refl eq_refl)))))
        ...
        | (Case t28 p20 t29) => (f_equal3 Case (tsubst_tsubst0_Tm_comm_ind t28 k d0 S1 S2) (tsubst_tsubst0_Pat_comm_ind p20 k d0 S1 S2) (eq_trans (f_equal3 tsubstTm (eq_trans (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (stability_tsubst_bind _ _ _) (eq_refl H0)))) (weakenTrace_append TyVar d0 k (appendHvl H0 (bind p20)))) eq_refl (f_equal3 tsubstTm (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p20))) eq_refl eq_refl)) (eq_trans (tsubst_tsubst0_Tm_comm_ind t29 (appendHvl k (appendHvl H0 (bind p20))) d0 S1 S2) (f_equal3 tsubstTm (eq_trans (eq_sym (weakenTrace_append TyVar X0 k (appendHvl H0 (bind p20)))) (f_equal2 weakenTrace eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (eq_sym (stability_tsubst_bind _ _ _)) (eq_refl H0))))) eq_refl (f_equal3 tsubstTm (eq_sym (weakenTrace_append TyVar (XS TyVar d0) k (appendHvl H0 (bind p20)))) eq_refl eq_refl)))))
      end.
  ...
  Section SubstSubstComm.
    ...
    Definition tsubstPat_tsubstPat0_comm (p20 : Pat) : (forall (d0 : (Trace TyVar)) (S1 : Ty) (S2 : Ty) ,
      ((tsubstPat d0 S1 (tsubstPat X0 S2 p20)) = (tsubstPat X0 (tsubstTy d0 S1 S2) (tsubstPat (XS TyVar d0) S1 p20)))) := (tsubst_tsubst0_Pat_comm_ind p20 H0).
  ...
  Section WeakenSubst.
    ...
    Lemma weakenPat_tsubstPat  :
      (forall (k : Hvl) (d0 : (Trace TyVar)) (S1 : Ty) (p20 : Pat) ,
...
Section WellFormed.
  ...
  Inductive wfPat (k : Hvl) : Pat -> Prop :=
    ...
    | wfPat_PProd {p20 : Pat}
        ...
        (wf0 : (wfPat (appendHvl k (appendHvl H0 (bind p20))) p21))
  ...
  Inductive wfTm (k : Hvl) : Tm -> Prop :=
    ...
    | wfTm_Prod {t32 : Tm}
        ...
        (wfTm k (Prod t32 t33))
    | wfTm_Case {t34 : Tm}
        (wf : (wfTm k t34)) {p20 : Pat}
        (wf0 : (wfPat k p20)) {t35 : Tm}
        (wf1 : (wfTm (appendHvl k (appendHvl H0 (bind p20))) t35))
        : (wfTm k (Case t34 p20 t35)).
  ...
  Definition inversion_wfPat_PProd_1 (k4 : Hvl) (p1 : Pat) (p2 : Pat) (H29 : (wfPat k4 (PProd p1 p2))) : (wfPat (appendHvl k4 (appendHvl H0 (bind p1))) p2) := match H29 in (wfPat _ p21) return match p21 return Prop with
    | (PProd p1 p2) => (wfPat (appendHvl k4 (appendHvl H0 (bind p1))) p2)
    | _ => True
  end with
    | (wfPat_PProd p1 H8 p2 H9) => H9
    | _ => I
  end.
  Definition inversion_wfTm_Var_1 (k5 : Hvl) (x : (Index TmVar)) (H30 : (wfTm k5 (Var x))) : (wfindex k5 x) := match H30 in (wfTm _ s) return match s return Prop with
    | (Var x) => (wfindex k5 x)
    | _ => True
  end with
    | (wfTm_Var x H10) => H10
  ...
  Definition inversion_wfTm_Abs_2 (k6 : Hvl) (T : Ty) (t : Tm) (H31 : (wfTm k6 (Abs T t))) : (wfTm (HS TmVar k6) t) := match H31 in (wfTm _ s0) return match s0 return Prop with
  ...
  Definition inversion_wfTm_TAbs_1 (k8 : Hvl) (t : Tm) (H33 : (wfTm k8 (TAbs t))) : (wfTm (HS TyVar k8) t) := match H33 in (wfTm _ s2) return match s2 return Prop with
    | (TAbs t) => (wfTm (HS TyVar k8) t)
    | _ => True
  end with
    | (wfTm_TAbs t H15) => H15
    | _ => I
  ...
  Definition inversion_wfTm_Case_0 (k11 : Hvl) (t1 : Tm) (p : Pat) (t2 : Tm) (H36 : (wfTm k11 (Case t1 p t2))) : (wfTm k11 t1) := match H36 in (wfTm _ s5) return match s5 return Prop with
    | (Case t1 p t2) => (wfTm k11 t1)
    | _ => True
  end with
    | (wfTm_Case t1 H20 p H21 t2 H22) => H20
    | _ => I
  end.
  Definition inversion_wfTm_Case_1 (k11 : Hvl) (t1 : Tm) (p : Pat) (t2 : Tm) (H36 : (wfTm k11 (Case t1 p t2))) : (wfPat k11 p) := match H36 in (wfTm _ s5) return match s5 return Prop with
    | (Case t1 p t2) => (wfPat k11 p)
    | _ => True
  end with
    | (wfTm_Case t1 H20 p H21 t2 H22) => H21
    | _ => I
  end.
  Definition inversion_wfTm_Case_2 (k11 : Hvl) (t1 : Tm) (p : Pat) (t2 : Tm) (H36 : (wfTm k11 (Case t1 p t2))) : (wfTm (appendHvl k11 (appendHvl H0 (bind p))) t2) := match H36 in (wfTm _ s5) return match s5 return Prop with
    | (Case t1 p t2) => (wfTm (appendHvl k11 (appendHvl H0 (bind p))) t2)
    | _ => True
  end with
...
Section ShiftWellFormed.
  Inductive shifthvl_TmVar : (forall (c0 : (Cutoff TmVar)) (k12 : Hvl) (k13 : Hvl) ,
    Prop) :=
    | shifthvl_TmVar_here
        (k12 : Hvl) :
        (shifthvl_TmVar C0 k12 (HS TmVar k12))
    | shifthvl_TmVar_there_TmVar
        (c0 : (Cutoff TmVar))
        (k12 : Hvl) (k13 : Hvl) :
        (shifthvl_TmVar c0 k12 k13) -> (shifthvl_TmVar (CS c0) (HS TmVar k12) (HS TmVar k13))
    | shifthvl_TmVar_there_TyVar
        (c0 : (Cutoff TmVar))
        (k12 : Hvl) (k13 : Hvl) :
        (shifthvl_TmVar c0 k12 k13) -> (shifthvl_TmVar c0 (HS TyVar k12) (HS TyVar k13)).
  Inductive shifthvl_TyVar : (forall (c0 : (Cutoff TyVar)) (k12 : Hvl) (k13 : Hvl) ,
    Prop) :=
    | shifthvl_TyVar_here
        (k12 : Hvl) :
        (shifthvl_TyVar C0 k12 (HS TyVar k12))
    | shifthvl_TyVar_there_TmVar
        (c0 : (Cutoff TyVar))
        (k12 : Hvl) (k13 : Hvl) :
        (shifthvl_TyVar c0 k12 k13) -> (shifthvl_TyVar c0 (HS TmVar k12) (HS TmVar k13))
    | shifthvl_TyVar_there_TyVar
        (c0 : (Cutoff TyVar))
        (k12 : Hvl) (k13 : Hvl) :
        (shifthvl_TyVar c0 k12 k13) -> (shifthvl_TyVar (CS c0) (HS TyVar k12) (HS TyVar k13)).
  Lemma weaken_shifthvl_TmVar  :
    (forall (k12 : Hvl) {c0 : (Cutoff TmVar)} {k13 : Hvl} {k14 : Hvl} ,
      (shifthvl_TmVar c0 k13 k14) -> (shifthvl_TmVar (weakenCutoffTmVar c0 k12) (appendHvl k13 k12) (appendHvl k14 k12))).
  Proof.
    needleGenericWeakenHVarlistInsert .
  Qed.
  Lemma weaken_shifthvl_TyVar  :
    (forall (k12 : Hvl) {c0 : (Cutoff TyVar)} {k13 : Hvl} {k14 : Hvl} ,
      (shifthvl_TyVar c0 k13 k14) -> (shifthvl_TyVar (weakenCutoffTyVar c0 k12) (appendHvl k13 k12) (appendHvl k14 k12))).
  Proof.
    needleGenericWeakenHVarlistInsert .
  Qed.
  Lemma shift_wfindex_TmVar  :
    (forall (c0 : (Cutoff TmVar)) (k12 : Hvl) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) (x13 : (Index TmVar)) ,
      (wfindex k12 x13) -> (wfindex k13 (shiftIndex c0 x13))).
  Proof.
    needleGenericShiftWellFormedIndex .
  Qed.
  Lemma shift_wfindex_TyVar  :
    (forall (c0 : (Cutoff TmVar)) (k12 : Hvl) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) (X12 : (Index TyVar)) ,
      (wfindex k12 X12) -> (wfindex k13 X12)).
  Proof.
    needleGenericShiftWellFormedIndex .
  Qed.
  Lemma tshift_wfindex_TmVar  :
    (forall (c0 : (Cutoff TyVar)) (k12 : Hvl) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) (x13 : (Index TmVar)) ,
      (wfindex k12 x13) -> (wfindex k13 x13)).
  Proof.
    needleGenericShiftWellFormedIndex .
  Qed.
  Lemma tshift_wfindex_TyVar  :
    (forall (c0 : (Cutoff TyVar)) (k12 : Hvl) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) (X12 : (Index TyVar)) ,
  ...
  Definition shift_wfTy : (forall (k12 : Hvl) ,
    (forall (S5 : Ty) (wf : (wfTy k12 S5)) ,
      (forall (c0 : (Cutoff TmVar)) (k13 : Hvl) ,
        (shifthvl_TmVar c0 k12 k13) -> (wfTy k13 S5)))) := (ind_wfTy (fun (k12 : Hvl) (S5 : Ty) (wf : (wfTy k12 S5)) =>
    (forall (c0 : (Cutoff TmVar)) (k13 : Hvl) ,
      (shifthvl_TmVar c0 k12 k13) -> (wfTy k13 S5))) (fun (k12 : Hvl) (X12 : (Index TyVar)) (wfi : (wfindex k12 X12)) (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTy_TVar k13 _ (shift_wfindex_TyVar c0 k12 k13 ins X12 wfi))) (fun (k12 : Hvl) (T1 : Ty) (wf : (wfTy k12 T1)) IHT1 (T2 : Ty) (wf0 : (wfTy k12 T2)) IHT2 (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTy_TArr k13 (IHT1 c0 k13 (weaken_shifthvl_TmVar H0 ins)) (IHT2 c0 k13 (weaken_shifthvl_TmVar H0 ins)))) (fun (k12 : Hvl) (T : Ty) (wf : (wfTy (HS TyVar k12) T)) IHT (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTy_TAll k13 (IHT c0 (HS TyVar k13) (weaken_shifthvl_TmVar (HS TyVar H0) ins)))) (fun (k12 : Hvl) (T1 : Ty) (wf : (wfTy k12 T1)) IHT1 (T2 : Ty) (wf0 : (wfTy k12 T2)) IHT2 (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTy_TProd k13 (IHT1 c0 k13 (weaken_shifthvl_TmVar H0 ins)) (IHT2 c0 k13 (weaken_shifthvl_TmVar H0 ins))))).
  Definition tshift_wfTy : (forall (k12 : Hvl) ,
    (forall (S5 : Ty) (wf : (wfTy k12 S5)) ,
      (forall (c0 : (Cutoff TyVar)) (k13 : Hvl) ,
        (shifthvl_TyVar c0 k12 k13) -> (wfTy k13 (tshiftTy c0 S5))))) := (ind_wfTy (fun (k12 : Hvl) (S5 : Ty) (wf : (wfTy k12 S5)) =>
    (forall (c0 : (Cutoff TyVar)) (k13 : Hvl) ,
      (shifthvl_TyVar c0 k12 k13) -> (wfTy k13 (tshiftTy c0 S5)))) (fun (k12 : Hvl) (X12 : (Index TyVar)) (wfi : (wfindex k12 X12)) (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTy_TVar k13 _ (tshift_wfindex_TyVar c0 k12 k13 ins X12 wfi))) (fun (k12 : Hvl) (T1 : Ty) (wf : (wfTy k12 T1)) IHT1 (T2 : Ty) (wf0 : (wfTy k12 T2)) IHT2 (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTy_TArr k13 (IHT1 c0 k13 (weaken_shifthvl_TyVar H0 ins)) (IHT2 c0 k13 (weaken_shifthvl_TyVar H0 ins)))) (fun (k12 : Hvl) (T : Ty) (wf : (wfTy (HS TyVar k12) T)) IHT (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTy_TAll k13 (IHT (CS c0) (HS TyVar k13) (weaken_shifthvl_TyVar (HS TyVar H0) ins)))) (fun (k12 : Hvl) (T1 : Ty) (wf : (wfTy k12 T1)) IHT1 (T2 : Ty) (wf0 : (wfTy k12 T2)) IHT2 (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTy_TProd k13 (IHT1 c0 k13 (weaken_shifthvl_TyVar H0 ins)) (IHT2 c0 k13 (weaken_shifthvl_TyVar H0 ins))))).
  Definition shift_wfPat : (forall (k12 : Hvl) ,
    (forall (p22 : Pat) (wf : (wfPat k12 p22)) ,
      (forall (c0 : (Cutoff TmVar)) (k13 : Hvl) ,
        (shifthvl_TmVar c0 k12 k13) -> (wfPat k13 p22)))) := (ind_wfPat (fun (k12 : Hvl) (p22 : Pat) (wf : (wfPat k12 p22)) =>
    (forall (c0 : (Cutoff TmVar)) (k13 : Hvl) ,
      (shifthvl_TmVar c0 k12 k13) -> (wfPat k13 p22))) (fun (k12 : Hvl) (T : Ty) (wf : (wfTy k12 T)) (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfPat_PVar k13 (shift_wfTy k12 T wf c0 k13 (weaken_shifthvl_TmVar H0 ins)))) (fun (k12 : Hvl) (p1 : Pat) (wf : (wfPat k12 p1)) IHp1 (p2 : Pat) (wf0 : (wfPat (appendHvl k12 (appendHvl H0 (bind p1))) p2)) IHp2 (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfPat_PProd k13 (IHp1 c0 k13 (weaken_shifthvl_TmVar H0 ins)) (IHp2 (weakenCutoffTmVar c0 (appendHvl H0 (bind p1))) (appendHvl k13 (appendHvl H0 (bind p1))) (weaken_shifthvl_TmVar (appendHvl H0 (bind p1)) ins))))).
  Definition tshift_wfPat : (forall (k12 : Hvl) ,
    (forall (p22 : Pat) (wf : (wfPat k12 p22)) ,
      (forall (c0 : (Cutoff TyVar)) (k13 : Hvl) ,
        (shifthvl_TyVar c0 k12 k13) -> (wfPat k13 (tshiftPat c0 p22))))) := (ind_wfPat (fun (k12 : Hvl) (p22 : Pat) (wf : (wfPat k12 p22)) =>
    (forall (c0 : (Cutoff TyVar)) (k13 : Hvl) ,
      (shifthvl_TyVar c0 k12 k13) -> (wfPat k13 (tshiftPat c0 p22)))) (fun (k12 : Hvl) (T : Ty) (wf : (wfTy k12 T)) (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfPat_PVar k13 (tshift_wfTy k12 T wf c0 k13 (weaken_shifthvl_TyVar H0 ins)))) (fun (k12 : Hvl) (p1 : Pat) (wf : (wfPat k12 p1)) IHp1 (p2 : Pat) (wf0 : (wfPat (appendHvl k12 (appendHvl H0 (bind p1))) p2)) IHp2 (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfPat_PProd k13 (IHp1 c0 k13 (weaken_shifthvl_TyVar H0 ins)) (eq_ind2 wfPat (f_equal2 appendHvl (eq_refl k13) (f_equal2 appendHvl (eq_refl H0) (eq_sym (stability_tshift_bind _ _)))) eq_refl (IHp2 (weakenCutoffTyVar c0 (appendHvl H0 (bind p1))) (appendHvl k13 (appendHvl H0 (bind p1))) (weaken_shifthvl_TyVar (appendHvl H0 (bind p1)) ins)))))).
  Definition shift_wfTm : (forall (k12 : Hvl) ,
    (forall (s6 : Tm) (wf : (wfTm k12 s6)) ,
      (forall (c0 : (Cutoff TmVar)) (k13 : Hvl) ,
        (shifthvl_TmVar c0 k12 k13) -> (wfTm k13 (shiftTm c0 s6))))) := (ind_wfTm (fun (k12 : Hvl) (s6 : Tm) (wf : (wfTm k12 s6)) =>
    (forall (c0 : (Cutoff TmVar)) (k13 : Hvl) ,
      (shifthvl_TmVar c0 k12 k13) -> (wfTm k13 (shiftTm c0 s6)))) (fun (k12 : Hvl) (x13 : (Index TmVar)) (wfi : (wfindex k12 x13)) (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTm_Var k13 _ (shift_wfindex_TmVar c0 k12 k13 ins x13 wfi))) (fun (k12 : Hvl) (T : Ty) (wf : (wfTy k12 T)) (t : Tm) (wf0 : (wfTm (HS TmVar k12) t)) IHt (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTm_Abs k13 (shift_wfTy k12 T wf c0 k13 (weaken_shifthvl_TmVar H0 ins)) (IHt (CS c0) (HS TmVar k13) (weaken_shifthvl_TmVar (HS TmVar H0) ins)))) (fun (k12 : Hvl) (t1 : Tm) (wf : (wfTm k12 t1)) IHt1 (t2 : Tm) (wf0 : (wfTm k12 t2)) IHt2 (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTm_App k13 (IHt1 c0 k13 (weaken_shifthvl_TmVar H0 ins)) (IHt2 c0 k13 (weaken_shifthvl_TmVar H0 ins)))) (fun (k12 : Hvl) (t : Tm) (wf : (wfTm (HS TyVar k12) t)) IHt (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTm_TAbs k13 (IHt c0 (HS TyVar k13) (weaken_shifthvl_TmVar (HS TyVar H0) ins)))) (fun (k12 : Hvl) (t : Tm) (wf : (wfTm k12 t)) IHt (T : Ty) (wf0 : (wfTy k12 T)) (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTm_TApp k13 (IHt c0 k13 (weaken_shifthvl_TmVar H0 ins)) (shift_wfTy k12 T wf0 c0 k13 (weaken_shifthvl_TmVar H0 ins)))) (fun (k12 : Hvl) (t1 : Tm) (wf : (wfTm k12 t1)) IHt1 (t2 : Tm) (wf0 : (wfTm k12 t2)) IHt2 (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTm_Prod k13 (IHt1 c0 k13 (weaken_shifthvl_TmVar H0 ins)) (IHt2 c0 k13 (weaken_shifthvl_TmVar H0 ins)))) (fun (k12 : Hvl) (t1 : Tm) (wf : (wfTm k12 t1)) IHt1 (p : Pat) (wf0 : (wfPat k12 p)) (t2 : Tm) (wf1 : (wfTm (appendHvl k12 (appendHvl H0 (bind p))) t2)) IHt2 (c0 : (Cutoff TmVar)) (k13 : Hvl) (ins : (shifthvl_TmVar c0 k12 k13)) =>
    (wfTm_Case k13 (IHt1 c0 k13 (weaken_shifthvl_TmVar H0 ins)) (shift_wfPat k12 p wf0 c0 k13 (weaken_shifthvl_TmVar H0 ins)) (IHt2 (weakenCutoffTmVar c0 (appendHvl H0 (bind p))) (appendHvl k13 (appendHvl H0 (bind p))) (weaken_shifthvl_TmVar (appendHvl H0 (bind p)) ins))))).
  Definition tshift_wfTm : (forall (k12 : Hvl) ,
    (forall (s6 : Tm) (wf : (wfTm k12 s6)) ,
      (forall (c0 : (Cutoff TyVar)) (k13 : Hvl) ,
        (shifthvl_TyVar c0 k12 k13) -> (wfTm k13 (tshiftTm c0 s6))))) := (ind_wfTm (fun (k12 : Hvl) (s6 : Tm) (wf : (wfTm k12 s6)) =>
    (forall (c0 : (Cutoff TyVar)) (k13 : Hvl) ,
      (shifthvl_TyVar c0 k12 k13) -> (wfTm k13 (tshiftTm c0 s6)))) (fun (k12 : Hvl) (x13 : (Index TmVar)) (wfi : (wfindex k12 x13)) (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTm_Var k13 _ (tshift_wfindex_TmVar c0 k12 k13 ins x13 wfi))) (fun (k12 : Hvl) (T : Ty) (wf : (wfTy k12 T)) (t : Tm) (wf0 : (wfTm (HS TmVar k12) t)) IHt (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTm_Abs k13 (tshift_wfTy k12 T wf c0 k13 (weaken_shifthvl_TyVar H0 ins)) (IHt c0 (HS TmVar k13) (weaken_shifthvl_TyVar (HS TmVar H0) ins)))) (fun (k12 : Hvl) (t1 : Tm) (wf : (wfTm k12 t1)) IHt1 (t2 : Tm) (wf0 : (wfTm k12 t2)) IHt2 (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTm_App k13 (IHt1 c0 k13 (weaken_shifthvl_TyVar H0 ins)) (IHt2 c0 k13 (weaken_shifthvl_TyVar H0 ins)))) (fun (k12 : Hvl) (t : Tm) (wf : (wfTm (HS TyVar k12) t)) IHt (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTm_TAbs k13 (IHt (CS c0) (HS TyVar k13) (weaken_shifthvl_TyVar (HS TyVar H0) ins)))) (fun (k12 : Hvl) (t : Tm) (wf : (wfTm k12 t)) IHt (T : Ty) (wf0 : (wfTy k12 T)) (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTm_TApp k13 (IHt c0 k13 (weaken_shifthvl_TyVar H0 ins)) (tshift_wfTy k12 T wf0 c0 k13 (weaken_shifthvl_TyVar H0 ins)))) (fun (k12 : Hvl) (t1 : Tm) (wf : (wfTm k12 t1)) IHt1 (t2 : Tm) (wf0 : (wfTm k12 t2)) IHt2 (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTm_Prod k13 (IHt1 c0 k13 (weaken_shifthvl_TyVar H0 ins)) (IHt2 c0 k13 (weaken_shifthvl_TyVar H0 ins)))) (fun (k12 : Hvl) (t1 : Tm) (wf : (wfTm k12 t1)) IHt1 (p : Pat) (wf0 : (wfPat k12 p)) (t2 : Tm) (wf1 : (wfTm (appendHvl k12 (appendHvl H0 (bind p))) t2)) IHt2 (c0 : (Cutoff TyVar)) (k13 : Hvl) (ins : (shifthvl_TyVar c0 k12 k13)) =>
    (wfTm_Case k13 (IHt1 c0 k13 (weaken_shifthvl_TyVar H0 ins)) (tshift_wfPat k12 p wf0 c0 k13 (weaken_shifthvl_TyVar H0 ins)) (eq_ind2 wfTm (f_equal2 appendHvl (eq_refl k13) (f_equal2 appendHvl (eq_refl H0) (eq_sym (stability_tshift_bind _ _)))) eq_refl (IHt2 (weakenCutoffTyVar c0 (appendHvl H0 (bind p))) (appendHvl k13 (appendHvl H0 (bind p))) (weaken_shifthvl_TyVar (appendHvl H0 (bind p)) ins)))))).
  ...
  (forall (k13 : Hvl) (S5 : Ty) (wf : (wfTy k13 S5)) ,
    ...
    match k12 return (forall (k13 : Hvl) (S5 : Ty) (wf : (wfTy k13 S5)) ,
      ...
      | (H0) => (fun (k13 : Hvl) (S5 : Ty) (wf : (wfTy k13 S5)) =>
        wf)
      | (HS TmVar k12) => (fun (k13 : Hvl) (S5 : Ty) (wf : (wfTy k13 S5)) =>
        (shift_wfTy (appendHvl k13 k12) (weakenTy S5 k12) (weaken_wfTy k12 k13 S5 wf) C0 (HS TmVar (appendHvl k13 k12)) (shifthvl_TmVar_here (appendHvl k13 k12))))
      | (HS TyVar k12) => (fun (k13 : Hvl) (S5 : Ty) (wf : (wfTy k13 S5)) =>
        (tshift_wfTy (appendHvl k13 k12) (weakenTy S5 k12) (weaken_wfTy k12 k13 S5 wf) C0 (HS TyVar (appendHvl k13 k12)) (shifthvl_TyVar_here (appendHvl k13 k12))))
    end.
  ...
  (forall (k13 : Hvl) (p22 : Pat) (wf : (wfPat k13 p22)) ,
    ...
    match k12 return (forall (k13 : Hvl) (p22 : Pat) (wf : (wfPat k13 p22)) ,
      ...
      | (H0) => (fun (k13 : Hvl) (p22 : Pat) (wf : (wfPat k13 p22)) =>
        wf)
      | (HS TmVar k12) => (fun (k13 : Hvl) (p22 : Pat) (wf : (wfPat k13 p22)) =>
        (shift_wfPat (appendHvl k13 k12) (weakenPat p22 k12) (weaken_wfPat k12 k13 p22 wf) C0 (HS TmVar (appendHvl k13 k12)) (shifthvl_TmVar_here (appendHvl k13 k12))))
      | (HS TyVar k12) => (fun (k13 : Hvl) (p22 : Pat) (wf : (wfPat k13 p22)) =>
        (tshift_wfPat (appendHvl k13 k12) (weakenPat p22 k12) (weaken_wfPat k12 k13 p22 wf) C0 (HS TyVar (appendHvl k13 k12)) (shifthvl_TyVar_here (appendHvl k13 k12))))
    end.
  ...
  (forall (k13 : Hvl) (s6 : Tm) (wf : (wfTm k13 s6)) ,
    ...
    match k12 return (forall (k13 : Hvl) (s6 : Tm) (wf : (wfTm k13 s6)) ,
      ...
      | (H0) => (fun (k13 : Hvl) (s6 : Tm) (wf : (wfTm k13 s6)) =>
        wf)
      | (HS TmVar k12) => (fun (k13 : Hvl) (s6 : Tm) (wf : (wfTm k13 s6)) =>
        (shift_wfTm (appendHvl k13 k12) (weakenTm s6 k12) (weaken_wfTm k12 k13 s6 wf) C0 (HS TmVar (appendHvl k13 k12)) (shifthvl_TmVar_here (appendHvl k13 k12))))
      | (HS TyVar k12) => (fun (k13 : Hvl) (s6 : Tm) (wf : (wfTm k13 s6)) =>
        (tshift_wfTm (appendHvl k13 k12) (weakenTm s6 k12) (weaken_wfTm k12 k13 s6 wf) C0 (HS TyVar (appendHvl k13 k12)) (shifthvl_TyVar_here (appendHvl k13 k12))))
    end.
End ShiftWellFormed.
Lemma wfTy_cast  :
...
Section SubstWellFormed.
  Inductive substhvl_TmVar (k12 : Hvl) : (forall (d0 : (Trace TmVar)) (k13 : Hvl) (k14 : Hvl) ,
    Prop) :=
    | substhvl_TmVar_here :
        (substhvl_TmVar k12 X0 (HS TmVar k12) k12)
    | substhvl_TmVar_there_TmVar
        {d0 : (Trace TmVar)} {k13 : Hvl}
        {k14 : Hvl} :
        (substhvl_TmVar k12 d0 k13 k14) -> (substhvl_TmVar k12 (XS TmVar d0) (HS TmVar k13) (HS TmVar k14))
    | substhvl_TmVar_there_TyVar
        {d0 : (Trace TmVar)} {k13 : Hvl}
        {k14 : Hvl} :
        (substhvl_TmVar k12 d0 k13 k14) -> (substhvl_TmVar k12 (XS TyVar d0) (HS TyVar k13) (HS TyVar k14)).
  Inductive substhvl_TyVar (k12 : Hvl) : (forall (d0 : (Trace TyVar)) (k13 : Hvl) (k14 : Hvl) ,
    Prop) :=
    | substhvl_TyVar_here :
        (substhvl_TyVar k12 X0 (HS TyVar k12) k12)
    | substhvl_TyVar_there_TmVar
        {d0 : (Trace TyVar)} {k13 : Hvl}
        {k14 : Hvl} :
        (substhvl_TyVar k12 d0 k13 k14) -> (substhvl_TyVar k12 (XS TmVar d0) (HS TmVar k13) (HS TmVar k14))
    | substhvl_TyVar_there_TyVar
        {d0 : (Trace TyVar)} {k13 : Hvl}
        {k14 : Hvl} :
        (substhvl_TyVar k12 d0 k13 k14) -> (substhvl_TyVar k12 (XS TyVar d0) (HS TyVar k13) (HS TyVar k14)).
  Lemma weaken_substhvl_TmVar  :
    (forall {k13 : Hvl} (k12 : Hvl) {d0 : (Trace TmVar)} {k14 : Hvl} {k15 : Hvl} ,
      (substhvl_TmVar k13 d0 k14 k15) -> (substhvl_TmVar k13 (weakenTrace d0 k12) (appendHvl k14 k12) (appendHvl k15 k12))).
  Proof.
    needleGenericWeakenSubstHvl .
  Qed.
  Lemma weaken_substhvl_TyVar  :
    (forall {k13 : Hvl} (k12 : Hvl) {d0 : (Trace TyVar)} {k14 : Hvl} {k15 : Hvl} ,
      (substhvl_TyVar k13 d0 k14 k15) -> (substhvl_TyVar k13 (weakenTrace d0 k12) (appendHvl k14 k12) (appendHvl k15 k12))).
  Proof.
    needleGenericWeakenSubstHvl .
  Qed.
  Lemma substhvl_TmVar_wfindex_TmVar {k16 : Hvl} {s6 : Tm} (wft : (wfTm k16 s6)) :
    (forall {d0 : (Trace TmVar)} {k17 : Hvl} {k18 : Hvl} ,
      (substhvl_TmVar k16 d0 k17 k18) -> (forall {x13 : (Index TmVar)} ,
        (wfindex k17 x13) -> (wfTm k18 (substIndex d0 s6 x13)))).
  Proof.
    needleGenericSubstHvlWfIndexHom .
  Qed.
  Lemma substhvl_TyVar_wfindex_TyVar {k16 : Hvl} {S6 : Ty} (wft : (wfTy k16 S6)) :
    (forall {d0 : (Trace TyVar)} {k17 : Hvl} {k18 : Hvl} ,
      (substhvl_TyVar k16 d0 k17 k18) -> (forall {X12 : (Index TyVar)} ,
        (wfindex k17 X12) -> (wfTy k18 (tsubstIndex d0 S6 X12)))).
  Proof.
    needleGenericSubstHvlWfIndexHom .
  Qed.
  Lemma substhvl_TmVar_wfindex_TyVar {k16 : Hvl} :
    (forall {d0 : (Trace TmVar)} {k17 : Hvl} {k18 : Hvl} ,
      (substhvl_TmVar k16 d0 k17 k18) -> (forall {X12 : (Index TyVar)} ,
        (wfindex k17 X12) -> (wfindex k18 X12))).
  Proof.
    needleGenericSubstHvlWfIndexHet .
  Qed.
  Lemma substhvl_TyVar_wfindex_TmVar {k16 : Hvl} :
    (forall {d0 : (Trace TyVar)} {k17 : Hvl} {k18 : Hvl} ,
      (substhvl_TyVar k16 d0 k17 k18) -> (forall {x13 : (Index TmVar)} ,
        (wfindex k17 x13) -> (wfindex k18 x13))).
  Proof.
    needleGenericSubstHvlWfIndexHet .
  Qed.
  Definition substhvl_TmVar_wfTy {k16 : Hvl} : (forall (k17 : Hvl) ,
    (forall (S6 : Ty) (wf0 : (wfTy k17 S6)) ,
      (forall {d0 : (Trace TmVar)} {k18 : Hvl} ,
        (substhvl_TmVar k16 d0 k17 k18) -> (wfTy k18 S6)))) := (ind_wfTy (fun (k17 : Hvl) (S6 : Ty) (wf0 : (wfTy k17 S6)) =>
    (forall {d0 : (Trace TmVar)} {k18 : Hvl} ,
      (substhvl_TmVar k16 d0 k17 k18) -> (wfTy k18 S6))) (fun (k17 : Hvl) {X12 : (Index TyVar)} (wfi : (wfindex k17 X12)) {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfTy_TVar k18 _ (substhvl_TmVar_wfindex_TyVar del wfi))) (fun (k17 : Hvl) (T1 : Ty) (wf0 : (wfTy k17 T1)) IHT1 (T2 : Ty) (wf1 : (wfTy k17 T2)) IHT2 {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfTy_TArr k18 (IHT1 (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del)) (IHT2 (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del)))) (fun (k17 : Hvl) (T : Ty) (wf0 : (wfTy (HS TyVar k17) T)) IHT {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfTy_TAll k18 (IHT (weakenTrace d0 (HS TyVar H0)) (HS TyVar k18) (weaken_substhvl_TmVar (HS TyVar H0) del)))) (fun (k17 : Hvl) (T1 : Ty) (wf0 : (wfTy k17 T1)) IHT1 (T2 : Ty) (wf1 : (wfTy k17 T2)) IHT2 {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfTy_TProd k18 (IHT1 (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del)) (IHT2 (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del))))).
  Definition substhvl_TyVar_wfTy {k16 : Hvl} {S6 : Ty} (wf : (wfTy k16 S6)) : (forall (k17 : Hvl) ,
    (forall (S7 : Ty) (wf0 : (wfTy k17 S7)) ,
      (forall {d0 : (Trace TyVar)} {k18 : Hvl} ,
        (substhvl_TyVar k16 d0 k17 k18) -> (wfTy k18 (tsubstTy d0 S6 S7))))) := (ind_wfTy (fun (k17 : Hvl) (S7 : Ty) (wf0 : (wfTy k17 S7)) =>
    (forall {d0 : (Trace TyVar)} {k18 : Hvl} ,
      (substhvl_TyVar k16 d0 k17 k18) -> (wfTy k18 (tsubstTy d0 S6 S7)))) (fun (k17 : Hvl) {X12 : (Index TyVar)} (wfi : (wfindex k17 X12)) {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (substhvl_TyVar_wfindex_TyVar wf del wfi)) (fun (k17 : Hvl) (T1 : Ty) (wf0 : (wfTy k17 T1)) IHT1 (T2 : Ty) (wf1 : (wfTy k17 T2)) IHT2 {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfTy_TArr k18 (IHT1 (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del)) (IHT2 (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del)))) (fun (k17 : Hvl) (T : Ty) (wf0 : (wfTy (HS TyVar k17) T)) IHT {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfTy_TAll k18 (IHT (weakenTrace d0 (HS TyVar H0)) (HS TyVar k18) (weaken_substhvl_TyVar (HS TyVar H0) del)))) (fun (k17 : Hvl) (T1 : Ty) (wf0 : (wfTy k17 T1)) IHT1 (T2 : Ty) (wf1 : (wfTy k17 T2)) IHT2 {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfTy_TProd k18 (IHT1 (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del)) (IHT2 (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del))))).
  Definition substhvl_TmVar_wfPat {k16 : Hvl} : (forall (k17 : Hvl) ,
    (forall (p23 : Pat) (wf0 : (wfPat k17 p23)) ,
      (forall {d0 : (Trace TmVar)} {k18 : Hvl} ,
        (substhvl_TmVar k16 d0 k17 k18) -> (wfPat k18 p23)))) := (ind_wfPat (fun (k17 : Hvl) (p23 : Pat) (wf0 : (wfPat k17 p23)) =>
    (forall {d0 : (Trace TmVar)} {k18 : Hvl} ,
      (substhvl_TmVar k16 d0 k17 k18) -> (wfPat k18 p23))) (fun (k17 : Hvl) (T : Ty) (wf0 : (wfTy k17 T)) {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfPat_PVar k18 (substhvl_TmVar_wfTy k17 T wf0 (weaken_substhvl_TmVar H0 del)))) (fun (k17 : Hvl) (p1 : Pat) (wf0 : (wfPat k17 p1)) IHp1 (p2 : Pat) (wf1 : (wfPat (appendHvl k17 (appendHvl H0 (bind p1))) p2)) IHp2 {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfPat_PProd k18 (IHp1 (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del)) (IHp2 (weakenTrace d0 (appendHvl H0 (bind p1))) (appendHvl k18 (appendHvl H0 (bind p1))) (weaken_substhvl_TmVar (appendHvl H0 (bind p1)) del))))).
  Definition substhvl_TyVar_wfPat {k16 : Hvl} {S6 : Ty} (wf : (wfTy k16 S6)) : (forall (k17 : Hvl) ,
    (forall (p23 : Pat) (wf0 : (wfPat k17 p23)) ,
      (forall {d0 : (Trace TyVar)} {k18 : Hvl} ,
        (substhvl_TyVar k16 d0 k17 k18) -> (wfPat k18 (tsubstPat d0 S6 p23))))) := (ind_wfPat (fun (k17 : Hvl) (p23 : Pat) (wf0 : (wfPat k17 p23)) =>
    (forall {d0 : (Trace TyVar)} {k18 : Hvl} ,
      (substhvl_TyVar k16 d0 k17 k18) -> (wfPat k18 (tsubstPat d0 S6 p23)))) (fun (k17 : Hvl) (T : Ty) (wf0 : (wfTy k17 T)) {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfPat_PVar k18 (substhvl_TyVar_wfTy wf k17 T wf0 (weaken_substhvl_TyVar H0 del)))) (fun (k17 : Hvl) (p1 : Pat) (wf0 : (wfPat k17 p1)) IHp1 (p2 : Pat) (wf1 : (wfPat (appendHvl k17 (appendHvl H0 (bind p1))) p2)) IHp2 {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfPat_PProd k18 (IHp1 (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del)) (eq_ind2 wfPat (f_equal2 appendHvl (eq_refl k18) (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (eq_sym (stability_tsubst_bind _ _ _)) (eq_refl H0)))) eq_refl (IHp2 (weakenTrace d0 (appendHvl H0 (bind p1))) (appendHvl k18 (appendHvl H0 (bind p1))) (weaken_substhvl_TyVar (appendHvl H0 (bind p1)) del)))))).
  Definition substhvl_TmVar_wfTm {k16 : Hvl} {s6 : Tm} (wf : (wfTm k16 s6)) : (forall (k17 : Hvl) ,
    (forall (s7 : Tm) (wf0 : (wfTm k17 s7)) ,
      (forall {d0 : (Trace TmVar)} {k18 : Hvl} ,
        (substhvl_TmVar k16 d0 k17 k18) -> (wfTm k18 (substTm d0 s6 s7))))) := (ind_wfTm (fun (k17 : Hvl) (s7 : Tm) (wf0 : (wfTm k17 s7)) =>
    (forall {d0 : (Trace TmVar)} {k18 : Hvl} ,
      (substhvl_TmVar k16 d0 k17 k18) -> (wfTm k18 (substTm d0 s6 s7)))) (fun (k17 : Hvl) {x13 : (Index TmVar)} (wfi : (wfindex k17 x13)) {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (substhvl_TmVar_wfindex_TmVar wf del wfi)) (fun (k17 : Hvl) (T : Ty) (wf0 : (wfTy k17 T)) (t : Tm) (wf1 : (wfTm (HS TmVar k17) t)) IHt {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfTm_Abs k18 (substhvl_TmVar_wfTy k17 T wf0 (weaken_substhvl_TmVar H0 del)) (IHt (weakenTrace d0 (HS TmVar H0)) (HS TmVar k18) (weaken_substhvl_TmVar (HS TmVar H0) del)))) (fun (k17 : Hvl) (t1 : Tm) (wf0 : (wfTm k17 t1)) IHt1 (t2 : Tm) (wf1 : (wfTm k17 t2)) IHt2 {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfTm_App k18 (IHt1 (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del)) (IHt2 (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del)))) (fun (k17 : Hvl) (t : Tm) (wf0 : (wfTm (HS TyVar k17) t)) IHt {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfTm_TAbs k18 (IHt (weakenTrace d0 (HS TyVar H0)) (HS TyVar k18) (weaken_substhvl_TmVar (HS TyVar H0) del)))) (fun (k17 : Hvl) (t : Tm) (wf0 : (wfTm k17 t)) IHt (T : Ty) (wf1 : (wfTy k17 T)) {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfTm_TApp k18 (IHt (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del)) (substhvl_TmVar_wfTy k17 T wf1 (weaken_substhvl_TmVar H0 del)))) (fun (k17 : Hvl) (t1 : Tm) (wf0 : (wfTm k17 t1)) IHt1 (t2 : Tm) (wf1 : (wfTm k17 t2)) IHt2 {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfTm_Prod k18 (IHt1 (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del)) (IHt2 (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del)))) (fun (k17 : Hvl) (t1 : Tm) (wf0 : (wfTm k17 t1)) IHt1 (p : Pat) (wf1 : (wfPat k17 p)) (t2 : Tm) (wf2 : (wfTm (appendHvl k17 (appendHvl H0 (bind p))) t2)) IHt2 {d0 : (Trace TmVar)} {k18 : Hvl} (del : (substhvl_TmVar k16 d0 k17 k18)) =>
    (wfTm_Case k18 (IHt1 (weakenTrace d0 H0) k18 (weaken_substhvl_TmVar H0 del)) (substhvl_TmVar_wfPat k17 p wf1 (weaken_substhvl_TmVar H0 del)) (IHt2 (weakenTrace d0 (appendHvl H0 (bind p))) (appendHvl k18 (appendHvl H0 (bind p))) (weaken_substhvl_TmVar (appendHvl H0 (bind p)) del))))).
  Definition substhvl_TyVar_wfTm {k16 : Hvl} {S6 : Ty} (wf : (wfTy k16 S6)) : (forall (k17 : Hvl) ,
    (forall (s6 : Tm) (wf0 : (wfTm k17 s6)) ,
      (forall {d0 : (Trace TyVar)} {k18 : Hvl} ,
        (substhvl_TyVar k16 d0 k17 k18) -> (wfTm k18 (tsubstTm d0 S6 s6))))) := (ind_wfTm (fun (k17 : Hvl) (s6 : Tm) (wf0 : (wfTm k17 s6)) =>
    (forall {d0 : (Trace TyVar)} {k18 : Hvl} ,
      (substhvl_TyVar k16 d0 k17 k18) -> (wfTm k18 (tsubstTm d0 S6 s6)))) (fun (k17 : Hvl) {x13 : (Index TmVar)} (wfi : (wfindex k17 x13)) {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfTm_Var k18 _ (substhvl_TyVar_wfindex_TmVar del wfi))) (fun (k17 : Hvl) (T : Ty) (wf0 : (wfTy k17 T)) (t : Tm) (wf1 : (wfTm (HS TmVar k17) t)) IHt {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfTm_Abs k18 (substhvl_TyVar_wfTy wf k17 T wf0 (weaken_substhvl_TyVar H0 del)) (IHt (weakenTrace d0 (HS TmVar H0)) (HS TmVar k18) (weaken_substhvl_TyVar (HS TmVar H0) del)))) (fun (k17 : Hvl) (t1 : Tm) (wf0 : (wfTm k17 t1)) IHt1 (t2 : Tm) (wf1 : (wfTm k17 t2)) IHt2 {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfTm_App k18 (IHt1 (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del)) (IHt2 (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del)))) (fun (k17 : Hvl) (t : Tm) (wf0 : (wfTm (HS TyVar k17) t)) IHt {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfTm_TAbs k18 (IHt (weakenTrace d0 (HS TyVar H0)) (HS TyVar k18) (weaken_substhvl_TyVar (HS TyVar H0) del)))) (fun (k17 : Hvl) (t : Tm) (wf0 : (wfTm k17 t)) IHt (T : Ty) (wf1 : (wfTy k17 T)) {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfTm_TApp k18 (IHt (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del)) (substhvl_TyVar_wfTy wf k17 T wf1 (weaken_substhvl_TyVar H0 del)))) (fun (k17 : Hvl) (t1 : Tm) (wf0 : (wfTm k17 t1)) IHt1 (t2 : Tm) (wf1 : (wfTm k17 t2)) IHt2 {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfTm_Prod k18 (IHt1 (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del)) (IHt2 (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del)))) (fun (k17 : Hvl) (t1 : Tm) (wf0 : (wfTm k17 t1)) IHt1 (p : Pat) (wf1 : (wfPat k17 p)) (t2 : Tm) (wf2 : (wfTm (appendHvl k17 (appendHvl H0 (bind p))) t2)) IHt2 {d0 : (Trace TyVar)} {k18 : Hvl} (del : (substhvl_TyVar k16 d0 k17 k18)) =>
    (wfTm_Case k18 (IHt1 (weakenTrace d0 H0) k18 (weaken_substhvl_TyVar H0 del)) (substhvl_TyVar_wfPat wf k17 p wf1 (weaken_substhvl_TyVar H0 del)) (eq_ind2 wfTm (f_equal2 appendHvl (eq_refl k18) (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (eq_sym (stability_tsubst_bind _ _ _)) (eq_refl H0)))) eq_refl (IHt2 (weakenTrace d0 (appendHvl H0 (bind p))) (appendHvl k18 (appendHvl H0 (bind p))) (weaken_substhvl_TyVar (appendHvl H0 (bind p)) del)))))).
End SubstWellFormed.
...
Fixpoint subhvl_TmVar (k16 : Hvl) {struct k16} :
Prop :=
  match k16 with
    | (H0) => True
    | (HS a k16) => match a with
      | (TmVar) => (subhvl_TmVar k16)
      | _ => False
    end
  end.
Lemma subhvl_TmVar_append  :
  (forall (k16 : Hvl) (k17 : Hvl) ,
    (subhvl_TmVar k16) -> (subhvl_TmVar k17) -> (subhvl_TmVar (appendHvl k16 k17))).
Proof.
...
Lemma wfPat_strengthen_subhvl_TmVar  :
  (forall (k13 : Hvl) (k12 : Hvl) (p22 : Pat) ,
    (subhvl_TmVar k13) -> (wfPat (appendHvl k12 k13) (weakenPat p22 k13)) -> (wfPat k12 p22)).
Proof.
  needleGenericWellformedStrengthen .
Qed.
Lemma wfTy_strengthen_subhvl_TmVar  :
  (forall (k15 : Hvl) (k14 : Hvl) (S5 : Ty) ,
    (subhvl_TmVar k15) -> (wfTy (appendHvl k14 k15) (weakenTy S5 k15)) -> (wfTy k14 S5)).
Proof.
  needleGenericWellformedStrengthen .
Qed.
 Hint Extern 2 ((wfPat _ _)) => match goal with
  | H40 : (wfPat (appendHvl _ _) (weakenPat _ _)) |- _ => apply (wfPat_strengthen_subhvl_TmVar) in H40
end : infra wf.
 Hint Extern 2 ((wfTy _ _)) => match goal with
  | H41 : (wfTy (appendHvl _ _) (weakenTy _ _)) |- _ => apply (wfTy_strengthen_subhvl_TmVar) in H41
end : infra wf.
Section Context.
  Inductive Env : Type :=
    | empty 
  ...
  Hvl :=
    match G2 with
      ...
      | (etvar G3) => (HS TyVar (domainEnv G3))
    end.
  ...
  Qed.
  Fixpoint shiftEnv (c0 : (Cutoff TmVar)) (G2 : Env) :
  Env :=
    match G2 with
      | (empty) => empty
  ...
  Fixpoint tshiftEnv (c0 : (Cutoff TyVar)) (G2 : Env) :
  Env :=
    match G2 with
      | (empty) => empty
      | (evar G3 T) => (evar (tshiftEnv c0 G3) (tshiftTy (weakenCutoffTyVar c0 (domainEnv G3)) T))
  ...
  Env :=
    match k16 with
      | (H0) => G2
      | (HS TmVar k16) => (weakenEnv G2 k16)
      | (HS TyVar k16) => (tshiftEnv C0 (weakenEnv G2 k16))
    end.
  Fixpoint substEnv (d0 : (Trace TmVar)) (s6 : Tm) (G2 : Env) :
  Env :=
    match G2 with
      | (empty) => empty
  ...
  Fixpoint tsubstEnv (d0 : (Trace TyVar)) (S6 : Ty) (G2 : Env) :
  Env :=
    match G2 with
      | (empty) => empty
...
Section ContextStuff.
  Section ShiftEnvAppendEnv.
    Lemma shiftEnv_appendEnv  :
      (forall (c0 : (Cutoff TmVar)) (G2 : Env) (G3 : Env) ,
        ((shiftEnv c0 (appendEnv G2 G3)) = (appendEnv (shiftEnv c0 G2) (shiftEnv (weakenCutoffTmVar c0 (domainEnv G2)) G3)))).
    Proof.
      needleGenericShiftEnvAppendEnv .
    Qed.
    Lemma tshiftEnv_appendEnv  :
      (forall (c0 : (Cutoff TyVar)) (G2 : Env) (G3 : Env) ,
        ((tshiftEnv c0 (appendEnv G2 G3)) = (appendEnv (tshiftEnv c0 G2) (tshiftEnv (weakenCutoffTyVar c0 (domainEnv G2)) G3)))).
    Proof.
      needleGenericShiftEnvAppendEnv .
    Qed.
  ...
  Section SubstEnvAppendEnv.
    Lemma substEnv_appendEnv  :
      (forall (d0 : (Trace TmVar)) (s6 : Tm) (G2 : Env) (G3 : Env) ,
    ...
    Lemma tsubstEnv_appendEnv  :
      (forall (d0 : (Trace TyVar)) (S6 : Ty) (G2 : Env) (G3 : Env) ,
  ...
  Section Lookups.
    ...
    Lemma lookup_evar_wf  :
      (forall {G2 : Env} {x13 : (Index TmVar)} (T44 : Ty) ,
        (lookup_evar G2 x13 T44) -> (wfTy (domainEnv G2) T44)).
    Proof.
      needleGenericLookupWellformedData .
    Qed.
    Lemma weaken_lookup_evar  :
      (forall {G2 : Env} (G3 : Env) {x13 : (Index TmVar)} (T44 : Ty) ,
        (lookup_evar G2 x13 T44) -> (lookup_evar (appendEnv G2 G3) (weakenIndexTmVar x13 (domainEnv G3)) (weakenTy T44 (domainEnv G3)))).
    Proof.
      needleGenericWeakenLookup .
    Qed.
    Lemma weaken_lookup_etvar  :
      (forall {G2 : Env} (G3 : Env) {X12 : (Index TyVar)} ,
        (lookup_etvar G2 X12) -> (lookup_etvar (appendEnv G2 G3) (weakenIndexTyVar X12 (domainEnv G3)))).
    Proof.
      needleGenericWeakenLookup .
    Qed.
    Lemma lookup_evar_wfindex  :
      (forall {G2 : Env} {x13 : (Index TmVar)} (T46 : Ty) ,
        (lookup_evar G2 x13 T46) -> (wfindex (domainEnv G2) x13)).
    Proof.
      needleGenericLookupWellformedIndex .
    Qed.
    Lemma lookup_etvar_wfindex  :
      (forall {G2 : Env} {X12 : (Index TyVar)} ,
  ...
  Lemma weaken_shift_evar  :
    (forall (G2 : Env) {c0 : (Cutoff TmVar)} {G3 : Env} {G4 : Env} ,
      (shift_evar c0 G3 G4) -> (shift_evar (weakenCutoffTmVar c0 (domainEnv G2)) (appendEnv G3 G2) (appendEnv G4 G2))).
  Proof.
  ...
  Lemma weaken_shift_etvar  :
    (forall (G2 : Env) {c0 : (Cutoff TyVar)} {G3 : Env} {G4 : Env} ,
      (shift_etvar c0 G3 G4) -> (shift_etvar (weakenCutoffTyVar c0 (domainEnv G2)) (appendEnv G3 G2) (appendEnv G4 (tshiftEnv c0 G2)))).
  Proof.
    needleGenericWeakenInsertEnv .
  Qed.
  Lemma shift_evar_shifthvl_TmVar  :
    (forall {c0 : (Cutoff TmVar)} {G2 : Env} {G3 : Env} ,
      (shift_evar c0 G2 G3) -> (shifthvl_TmVar c0 (domainEnv G2) (domainEnv G3))).
  Proof.
    needleGenericInsertEnvInsertHvl .
  Qed.
  Lemma shift_etvar_shifthvl_TyVar  :
    (forall {c0 : (Cutoff TyVar)} {G2 : Env} {G3 : Env} ,
      (shift_etvar c0 G2 G3) -> (shifthvl_TyVar c0 (domainEnv G2) (domainEnv G3))).
  Proof.
    needleGenericInsertEnvInsertHvl .
  Qed.
  Inductive subst_evar (G2 : Env) (T44 : Ty) (s6 : Tm) : (Trace TmVar) -> Env -> Env -> Prop :=
    | subst_evar_here :
        (subst_evar G2 T44 s6 X0 (evar G2 T44) G2)
    | subst_evar_there_evar
        {d0 : (Trace TmVar)} {G3 : Env}
        {G4 : Env} (T45 : Ty) :
        (subst_evar G2 T44 s6 d0 G3 G4) -> (subst_evar G2 T44 s6 (XS TmVar d0) (evar G3 T45) (evar G4 T45))
    | subst_evar_there_etvar
        {d0 : (Trace TmVar)} {G3 : Env}
        {G4 : Env} :
        (subst_evar G2 T44 s6 d0 G3 G4) -> (subst_evar G2 T44 s6 (XS TyVar d0) (etvar G3) (etvar G4)).
  Lemma weaken_subst_evar {G2 : Env} (T44 : Ty) {s6 : Tm} :
    (forall (G3 : Env) {d0 : (Trace TmVar)} {G4 : Env} {G5 : Env} ,
  ...
  Qed.
  Inductive subst_etvar (G2 : Env) (S6 : Ty) : (Trace TyVar) -> Env -> Env -> Prop :=
    | subst_etvar_here :
        (subst_etvar G2 S6 X0 (etvar G2) G2)
    | subst_etvar_there_evar
        {d0 : (Trace TyVar)} {G3 : Env}
        {G4 : Env} (T44 : Ty) :
        (subst_etvar G2 S6 d0 G3 G4) -> (subst_etvar G2 S6 (XS TmVar d0) (evar G3 T44) (evar G4 (tsubstTy d0 S6 T44)))
    | subst_etvar_there_etvar
        {d0 : (Trace TyVar)} {G3 : Env}
        {G4 : Env} :
        (subst_etvar G2 S6 d0 G3 G4) -> (subst_etvar G2 S6 (XS TyVar d0) (etvar G3) (etvar G4)).
  Lemma weaken_subst_etvar {G2 : Env} {S6 : Ty} :
    (forall (G3 : Env) {d0 : (Trace TyVar)} {G4 : Env} {G5 : Env} ,
      (subst_etvar G2 S6 d0 G4 G5) -> (subst_etvar G2 S6 (weakenTrace d0 (domainEnv G3)) (appendEnv G4 G3) (appendEnv G5 (tsubstEnv d0 S6 G3)))).
  Proof.
    needleGenericWeakenSubstEnv .
  Qed.
  Lemma subst_evar_substhvl_TmVar {G2 : Env} {s6 : Tm} (T44 : Ty) :
    (forall {d0 : (Trace TmVar)} {G3 : Env} {G4 : Env} ,
      (subst_evar G2 T44 s6 d0 G3 G4) -> (substhvl_TmVar (domainEnv G2) d0 (domainEnv G3) (domainEnv G4))).
  Proof.
    needleGenericSubstEnvSubstHvl .
  Qed.
  Lemma subst_etvar_substhvl_TyVar {G2 : Env} {S6 : Ty} :
    (forall {d0 : (Trace TyVar)} {G3 : Env} {G4 : Env} ,
      (subst_etvar G2 S6 d0 G3 G4) -> (substhvl_TyVar (domainEnv G2) d0 (domainEnv G3) (domainEnv G4))).
  Proof.
    needleGenericSubstEnvSubstHvl .
  Qed.
End ContextStuff.
...
Lemma weaken_lookup_evar_here  :
  (forall {G2 : Env} (G3 : Env) {T44 : Ty} (wf : (wfTy (domainEnv G2) T44)) ,
    (lookup_evar (appendEnv (evar G2 T44) G3) (weakenIndexTmVar I0 (domainEnv G3)) (weakenTy T44 (domainEnv G3)))).
Proof.
  eauto with lookup .
Qed.
Lemma weaken_lookup_etvar_here  :
  (forall {G2 : Env} (G3 : Env) ,
    (lookup_etvar (appendEnv (etvar G2) G3) (weakenIndexTyVar I0 (domainEnv G3)))).
Proof.
  eauto with lookup .
Qed.
 ...
 Hint Extern 2 ((wfTm _ _)) => match goal with
  ...
  | H40 : (wfTm _ (Case _ _ _)) |- _ => inversion H40; subst; clear H40
end : infra wf.
...
Lemma shift_evar_lookup_evar  :
  (forall {c0 : (Cutoff TmVar)} {G2 : Env} {G3 : Env} (ins : (shift_evar c0 G2 G3)) {x13 : (Index TmVar)} {T44 : Ty} ,
    (lookup_evar G2 x13 T44) -> (lookup_evar G3 (shiftIndex c0 x13) T44)).
Proof.
  needleGenericInsertLookup .
Qed.
Lemma shift_evar_lookup_etvar  :
  (forall {c0 : (Cutoff TmVar)} {G2 : Env} {G3 : Env} (ins : (shift_evar c0 G2 G3)) {X12 : (Index TyVar)} ,
    (lookup_etvar G2 X12) -> (lookup_etvar G3 X12)).
Proof.
  needleGenericInsertLookup .
Qed.
Lemma shift_etvar_lookup_evar  :
  (forall {c0 : (Cutoff TyVar)} {G2 : Env} {G3 : Env} (ins : (shift_etvar c0 G2 G3)) {x13 : (Index TmVar)} {T44 : Ty} ,
    (lookup_evar G2 x13 T44) -> (lookup_evar G3 x13 (tshiftTy c0 T44))).
Proof.
  needleGenericInsertLookup .
Qed.
Lemma shift_etvar_lookup_etvar  :
  (forall {c0 : (Cutoff TyVar)} {G2 : Env} {G3 : Env} (ins : (shift_etvar c0 G2 G3)) {X12 : (Index TyVar)} ,
...
Lemma subst_evar_lookup_etvar {G2 : Env} (T45 : Ty) {s6 : Tm} :
  (forall {d0 : (Trace TmVar)} {G3 : Env} {G4 : Env} (sub : (subst_evar G2 T45 s6 d0 G3 G4)) {X12 : (Index TyVar)} ,
...
Lemma subst_etvar_lookup_evar {G2 : Env} {S6 : Ty} (wf : (wfTy (domainEnv G2) S6)) :
  (forall {d0 : (Trace TyVar)} {G3 : Env} {G4 : Env} (sub : (subst_etvar G2 S6 d0 G3 G4)) {x13 : (Index TmVar)} (T45 : Ty) ,
...
nat :=
  match s with
    ...
    | (Case t34 p18 t35) => (plus 1 (plus (size_Tm t34) (plus (size_Pat p18) (size_Tm t35))))
  end.
...
Fixpoint tshift_size_Pat (p20 : Pat) (c0 : (Cutoff TyVar)) {struct p20} :
...
Inductive Typing (G2 : Env) : Tm -> Ty -> Prop :=
  ...
  | T_Let (T1 : Ty) (T2 : Ty)
      ...
      (jm7 : (Typing (appendEnv G2 (appendEnv empty G1)) t2 (weakenTy T2 (appendHvl H0 (bind p)))))
      (H45 : (wfTy (domainEnv G2) T2))
      : (Typing G2 (Case t1 p t2) T2).
Fixpoint domain_PTyping_bind (G4 : Env) (p25 : Pat) (T49 : Ty) (G5 : Env) (wtp8 : (PTyping G4 p25 T49 G5)) :
((domainEnv G5) = (bind p25)) :=
  match wtp8 in (PTyping _ p25 T49 G5) return ((domainEnv G5) = (bind p25)) with
    | (P_Var T46 H42) => (eq_refl (HS TmVar H0))
    | (P_Prod T47 T48 p23 p24 G2 G3 wtp6 wtp7 H44) => (eq_trans (domainEnv_appendEnv (appendEnv empty G2) G3) (f_equal2 appendHvl (eq_trans (domainEnv_appendEnv empty G2) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G4 p23 T47 G2 wtp6))) (domain_PTyping_bind (appendEnv G4 (appendEnv empty G2)) p24 (weakenTy T48 (appendHvl H0 (bind p23))) G3 wtp7)))
  end.
Lemma PTyping_cast  :
...
(forall (c0 : (Cutoff TmVar)) (G11 : Env) (H55 : (shift_evar c0 G9 G11)) ,
  (PTyping G11 p26 T53 G10)) :=
  match wtp9 in (PTyping _ p26 T53 G10) return (forall (c0 : (Cutoff TmVar)) (G11 : Env) (H55 : (shift_evar c0 G9 G11)) ,
    (PTyping G11 p26 T53 G10)) with
    | (P_Var T50 H48) => (fun (c0 : (Cutoff TmVar)) (G11 : Env) (H55 : (shift_evar c0 G9 G11)) =>
      (P_Var G11 T50 (shift_wfTy _ _ H48 _ _ (weaken_shifthvl_TmVar H0 (shift_evar_shifthvl_TmVar H55)))))
    | (P_Prod T51 T52 p24 p25 G7 G8 wtp7 wtp8 H50) => (fun (c0 : (Cutoff TmVar)) (G11 : Env) (H55 : (shift_evar c0 G9 G11)) =>
      (PTyping_cast G11 _ _ _ G11 (PProd p24 p25) (TProd T51 T52) _ eq_refl eq_refl eq_refl (eq_trans (f_equal2 appendEnv (eq_sym eq_refl) eq_refl) (eq_sym eq_refl)) (P_Prod G11 T51 T52 p24 p25 G7 G8 (shift_evar_PTyping G9 p24 T51 G7 wtp7 c0 G11 (weaken_shift_evar empty H55)) (PTyping_cast _ _ _ _ _ _ _ _ (f_equal2 appendEnv eq_refl eq_refl) eq_refl (eq_trans eq_refl (eq_sym eq_refl)) eq_refl (shift_evar_PTyping (appendEnv G9 (appendEnv empty G7)) p25 (weakenTy T52 (appendHvl H0 (bind p24))) G8 wtp8 (weakenCutoffTmVar c0 (domainEnv (appendEnv empty G7))) (appendEnv G11 (appendEnv empty G7)) (weaken_shift_evar (appendEnv empty G7) H55))) (shift_wfTy _ _ H50 _ _ (weaken_shifthvl_TmVar H0 (shift_evar_shifthvl_TmVar H55))))))
  end.
Fixpoint shift_etvar_PTyping (G9 : Env) (p26 : Pat) (T53 : Ty) (G10 : Env) (wtp9 : (PTyping G9 p26 T53 G10)) :
(forall (c0 : (Cutoff TyVar)) (G11 : Env) (H55 : (shift_etvar c0 G9 G11)) ,
  (PTyping G11 (tshiftPat c0 p26) (tshiftTy c0 T53) (tshiftEnv c0 G10))) :=
  match wtp9 in (PTyping _ p26 T53 G10) return (forall (c0 : (Cutoff TyVar)) (G11 : Env) (H55 : (shift_etvar c0 G9 G11)) ,
    (PTyping G11 (tshiftPat c0 p26) (tshiftTy c0 T53) (tshiftEnv c0 G10))) with
    | (P_Var T50 H48) => (fun (c0 : (Cutoff TyVar)) (G11 : Env) (H55 : (shift_etvar c0 G9 G11)) =>
      (P_Var G11 (tshiftTy c0 T50) (tshift_wfTy _ _ H48 _ _ (weaken_shifthvl_TyVar H0 (shift_etvar_shifthvl_TyVar H55)))))
    | (P_Prod T51 T52 p24 p25 G7 G8 wtp7 wtp8 H50) => (fun (c0 : (Cutoff TyVar)) (G11 : Env) (H55 : (shift_etvar c0 G9 G11)) =>
      (PTyping_cast G11 _ _ _ G11 (tshiftPat c0 (PProd p24 p25)) (tshiftTy c0 (TProd T51 T52)) _ eq_refl eq_refl eq_refl (eq_trans (f_equal2 appendEnv (eq_sym (tshiftEnv_appendEnv c0 empty G7)) eq_refl) (eq_sym (tshiftEnv_appendEnv c0 (appendEnv empty G7) G8))) (P_Prod G11 (tshiftTy c0 T51) (tshiftTy c0 T52) (tshiftPat c0 p24) (tshiftPat (weakenCutoffTyVar c0 (appendHvl H0 (bind p24))) p25) (tshiftEnv c0 G7) (tshiftEnv (weakenCutoffTyVar c0 (domainEnv (appendEnv empty G7))) G8) (shift_etvar_PTyping G9 p24 T51 G7 wtp7 c0 G11 (weaken_shift_etvar empty H55)) (PTyping_cast _ _ _ _ _ _ _ _ (f_equal2 appendEnv eq_refl (tshiftEnv_appendEnv c0 empty G7)) (f_equal2 tshiftPat (f_equal2 weakenCutoffTyVar eq_refl (eq_trans (domainEnv_appendEnv empty G7) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G9 p24 T51 G7 wtp7)))) eq_refl) (eq_trans (f_equal2 tshiftTy (f_equal2 weakenCutoffTyVar eq_refl (eq_trans (domainEnv_appendEnv empty G7) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G9 p24 T51 G7 wtp7)))) eq_refl) (eq_trans (eq_sym (weakenTy_tshiftTy (appendHvl H0 (bind p24)) c0 T52)) (f_equal2 weakenTy eq_refl (f_equal2 appendHvl (eq_refl H0) (eq_sym (stability_tshift_bind _ _)))))) eq_refl (shift_etvar_PTyping (appendEnv G9 (appendEnv empty G7)) p25 (weakenTy T52 (appendHvl H0 (bind p24))) G8 wtp8 (weakenCutoffTyVar c0 (domainEnv (appendEnv empty G7))) (appendEnv G11 (tshiftEnv c0 (appendEnv empty G7))) (weaken_shift_etvar (appendEnv empty G7) H55))) (tshift_wfTy _ _ H50 _ _ (weaken_shifthvl_TyVar H0 (shift_etvar_shifthvl_TyVar H55))))))
  end.
Fixpoint shift_evar_Typing (G8 : Env) (t31 : Tm) (T55 : Ty) (jm18 : (Typing G8 t31 T55)) :
(forall (c0 : (Cutoff TmVar)) (G9 : Env) (H73 : (shift_evar c0 G8 G9)) ,
  (Typing G9 (shiftTm c0 t31) T55)) :=
  match jm18 in (Typing _ t31 T55) return (forall (c0 : (Cutoff TmVar)) (G9 : Env) (H73 : (shift_evar c0 G8 G9)) ,
    (Typing G9 (shiftTm c0 t31) T55)) with
    | (T_Var T50 x15 lk0 H48 H49) => (fun (c0 : (Cutoff TmVar)) (G9 : Env) (H73 : (shift_evar c0 G8 G9)) =>
      (T_Var G9 T50 (shiftIndex c0 x15) (shift_evar_lookup_evar H73 lk0) (shift_wfTy _ _ H48 _ _ (weaken_shifthvl_TmVar H0 (shift_evar_shifthvl_TmVar H73))) (shift_wfindex_TmVar _ _ _ (weaken_shifthvl_TmVar H0 (shift_evar_shifthvl_TmVar H73)) _ H49)))
    | (T_Abs T51 T54 t28 jm9 H50 H51) => (fun (c0 : (Cutoff TmVar)) (G9 : Env) (H73 : (shift_evar c0 G8 G9)) =>
      (T_Abs G9 T51 T54 (shiftTm (CS c0) t28) (Typing_cast _ _ _ _ _ _ eq_refl eq_refl (eq_sym eq_refl) (shift_evar_Typing (evar G8 T51) t28 (weakenTy T54 (HS TmVar H0)) jm9 (CS c0) (evar G9 T51) (weaken_shift_evar (evar empty T51) H73))) (shift_wfTy _ _ H50 _ _ (weaken_shifthvl_TmVar H0 (shift_evar_shifthvl_TmVar H73))) (shift_wfTy _ _ H51 _ _ (weaken_shifthvl_TmVar H0 (shift_evar_shifthvl_TmVar H73)))))
    | (T_App T52 T53 t29 t30 jm10 jm11) => (fun (c0 : (Cutoff TmVar)) (G9 : Env) (H73 : (shift_evar c0 G8 G9)) =>
    ...
    | (T_Tabs T50 t28 jm12) => (fun (c0 : (Cutoff TmVar)) (G9 : Env) (H73 : (shift_evar c0 G8 G9)) =>
      (T_Tabs G9 T50 (shiftTm c0 t28) (shift_evar_Typing (etvar G8) t28 T50 jm12 c0 (etvar G9) (weaken_shift_evar (etvar empty) H73))))
    | (T_Tapp T53 T54 t29 jm13 H60) => (fun (c0 : (Cutoff TmVar)) (G9 : Env) (H73 : (shift_evar c0 G8 G9)) =>
      (T_Tapp G9 T53 T54 (shiftTm c0 t29) (shift_evar_Typing G8 t29 (TAll T53) jm13 c0 G9 (weaken_shift_evar empty H73)) (shift_wfTy _ _ H60 _ _ (weaken_shifthvl_TmVar H0 (shift_evar_shifthvl_TmVar H73)))))
    | (T_Prod T51 T54 t29 t30 jm14 jm15) => (fun (c0 : (Cutoff TmVar)) (G9 : Env) (H73 : (shift_evar c0 G8 G9)) =>
    ...
    | (T_Let T51 T54 p24 t29 t30 G7 jm16 wtp7 jm17 H67) => (fun (c0 : (Cutoff TmVar)) (G9 : Env) (H73 : (shift_evar c0 G8 G9)) =>
      (T_Let G9 T51 T54 p24 (shiftTm c0 t29) (shiftTm (weakenCutoffTmVar c0 (appendHvl H0 (bind p24))) t30) G7 (shift_evar_Typing G8 t29 T51 jm16 c0 G9 (weaken_shift_evar empty H73)) (shift_evar_PTyping G8 p24 T51 G7 wtp7 c0 G9 (weaken_shift_evar empty H73)) (Typing_cast _ _ _ _ _ _ (f_equal2 appendEnv eq_refl eq_refl) (f_equal2 shiftTm (f_equal2 weakenCutoffTmVar eq_refl (eq_trans (domainEnv_appendEnv empty G7) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G8 p24 T51 G7 wtp7)))) eq_refl) (eq_trans eq_refl (eq_sym eq_refl)) (shift_evar_Typing (appendEnv G8 (appendEnv empty G7)) t30 (weakenTy T54 (appendHvl H0 (bind p24))) jm17 (weakenCutoffTmVar c0 (domainEnv (appendEnv empty G7))) (appendEnv G9 (appendEnv empty G7)) (weaken_shift_evar (appendEnv empty G7) H73))) (shift_wfTy _ _ H67 _ _ (weaken_shifthvl_TmVar H0 (shift_evar_shifthvl_TmVar H73)))))
  end.
Fixpoint shift_etvar_Typing (G8 : Env) (t31 : Tm) (T55 : Ty) (jm18 : (Typing G8 t31 T55)) :
(forall (c0 : (Cutoff TyVar)) (G9 : Env) (H73 : (shift_etvar c0 G8 G9)) ,
  (Typing G9 (tshiftTm c0 t31) (tshiftTy c0 T55))) :=
  match jm18 in (Typing _ t31 T55) return (forall (c0 : (Cutoff TyVar)) (G9 : Env) (H73 : (shift_etvar c0 G8 G9)) ,
    (Typing G9 (tshiftTm c0 t31) (tshiftTy c0 T55))) with
    | (T_Var T50 x15 lk0 H48 H49) => (fun (c0 : (Cutoff TyVar)) (G9 : Env) (H73 : (shift_etvar c0 G8 G9)) =>
      (T_Var G9 (tshiftTy c0 T50) x15 (shift_etvar_lookup_evar H73 lk0) (tshift_wfTy _ _ H48 _ _ (weaken_shifthvl_TyVar H0 (shift_etvar_shifthvl_TyVar H73))) (tshift_wfindex_TmVar _ _ _ (weaken_shifthvl_TyVar H0 (shift_etvar_shifthvl_TyVar H73)) _ H49)))
    | (T_Abs T51 T54 t28 jm9 H50 H51) => (fun (c0 : (Cutoff TyVar)) (G9 : Env) (H73 : (shift_etvar c0 G8 G9)) =>
      (T_Abs G9 (tshiftTy c0 T51) (tshiftTy c0 T54) (tshiftTm c0 t28) (Typing_cast _ _ _ _ _ _ eq_refl eq_refl (eq_sym (weakenTy_tshiftTy (HS TmVar H0) c0 T54)) (shift_etvar_Typing (evar G8 T51) t28 (weakenTy T54 (HS TmVar H0)) jm9 c0 (evar G9 (tshiftTy c0 T51)) (weaken_shift_etvar (evar empty T51) H73))) (tshift_wfTy _ _ H50 _ _ (weaken_shifthvl_TyVar H0 (shift_etvar_shifthvl_TyVar H73))) (tshift_wfTy _ _ H51 _ _ (weaken_shifthvl_TyVar H0 (shift_etvar_shifthvl_TyVar H73)))))
    | (T_App T52 T53 t29 t30 jm10 jm11) => (fun (c0 : (Cutoff TyVar)) (G9 : Env) (H73 : (shift_etvar c0 G8 G9)) =>
    ...
    | (T_Tabs T50 t28 jm12) => (fun (c0 : (Cutoff TyVar)) (G9 : Env) (H73 : (shift_etvar c0 G8 G9)) =>
    ...
    | (T_Tapp T53 T54 t29 jm13 H60) => (fun (c0 : (Cutoff TyVar)) (G9 : Env) (H73 : (shift_etvar c0 G8 G9)) =>
      (Typing_cast G9 _ _ G9 (tshiftTm c0 (TApp t29 T54)) (tshiftTy c0 (tsubstTy X0 T54 T53)) eq_refl eq_refl (eq_sym (tshiftTy_tsubstTy0_comm T53 c0 T54)) (T_Tapp G9 (tshiftTy (CS c0) T53) (tshiftTy c0 T54) (tshiftTm c0 t29) (shift_etvar_Typing G8 t29 (TAll T53) jm13 c0 G9 (weaken_shift_etvar empty H73)) (tshift_wfTy _ _ H60 _ _ (weaken_shifthvl_TyVar H0 (shift_etvar_shifthvl_TyVar H73))))))
    | (T_Prod T51 T54 t29 t30 jm14 jm15) => (fun (c0 : (Cutoff TyVar)) (G9 : Env) (H73 : (shift_etvar c0 G8 G9)) =>
    ...
    | (T_Let T51 T54 p24 t29 t30 G7 jm16 wtp7 jm17 H67) => (fun (c0 : (Cutoff TyVar)) (G9 : Env) (H73 : (shift_etvar c0 G8 G9)) =>
      (T_Let G9 (tshiftTy c0 T51) (tshiftTy c0 T54) (tshiftPat c0 p24) (tshiftTm c0 t29) (tshiftTm (weakenCutoffTyVar c0 (appendHvl H0 (bind p24))) t30) (tshiftEnv c0 G7) (shift_etvar_Typing G8 t29 T51 jm16 c0 G9 (weaken_shift_etvar empty H73)) (shift_etvar_PTyping G8 p24 T51 G7 wtp7 c0 G9 (weaken_shift_etvar empty H73)) (Typing_cast _ _ _ _ _ _ (f_equal2 appendEnv eq_refl (tshiftEnv_appendEnv c0 empty G7)) (f_equal2 tshiftTm (f_equal2 weakenCutoffTyVar eq_refl (eq_trans (domainEnv_appendEnv empty G7) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G8 p24 T51 G7 wtp7)))) eq_refl) (eq_trans (f_equal2 tshiftTy (f_equal2 weakenCutoffTyVar eq_refl (eq_trans (domainEnv_appendEnv empty G7) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G8 p24 T51 G7 wtp7)))) eq_refl) (eq_trans (eq_sym (weakenTy_tshiftTy (appendHvl H0 (bind p24)) c0 T54)) (f_equal2 weakenTy eq_refl (f_equal2 appendHvl (eq_refl H0) (eq_sym (stability_tshift_bind _ _)))))) (shift_etvar_Typing (appendEnv G8 (appendEnv empty G7)) t30 (weakenTy T54 (appendHvl H0 (bind p24))) jm17 (weakenCutoffTyVar c0 (domainEnv (appendEnv empty G7))) (appendEnv G9 (tshiftEnv c0 (appendEnv empty G7))) (weaken_shift_etvar (appendEnv empty G7) H73))) (tshift_wfTy _ _ H67 _ _ (weaken_shifthvl_TyVar H0 (shift_etvar_shifthvl_TyVar H73)))))
  end.
...
(wfTm (domainEnv G2) t28) :=
  match jm9 in (Typing _ t28 T51) return (wfTm (domainEnv G2) t28) with
    ...
    | (T_Abs T1 T2 t jm H28 H29) => (wfTm_Abs (domainEnv G2) H28 (Typing_wf_0 (evar G2 T1) t (weakenTy T2 (HS TmVar H0)) jm))
    ...
    | (T_Let T1 T2 p t1 t2 G1 jm6 wtp jm7 H45) => (wfTm_Case (domainEnv G2) (Typing_wf_0 G2 t1 T1 jm6) (PTyping_wf_0 G2 p T1 G1 wtp) (wfTm_cast _ _ _ _ (eq_trans (domainEnv_appendEnv G2 (appendEnv empty G1)) (f_equal2 appendHvl (eq_refl (domainEnv G2)) (eq_trans (domainEnv_appendEnv empty G1) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G2 p T1 G1 wtp))))) eq_refl (Typing_wf_0 (appendEnv G2 (appendEnv empty G1)) t2 (weakenTy T2 (appendHvl H0 (bind p))) jm7)))
  end
...
(wfTy (domainEnv G2) T51) :=
  match jm10 in (Typing _ t28 T51) return (wfTy (domainEnv G2) T51) with
    ...
    | (T_Tapp T12 T2 t1 jm3 H38) => (substhvl_TyVar_wfTy H38 (HS TyVar (domainEnv G2)) T12 (inversion_wfTy_TAll_1 (domainEnv G2) T12 (Typing_wf_1 G2 t1 (TAll T12) jm3)) (substhvl_TyVar_here (domainEnv G2)))
...
Lemma subst_evar_lookup_evar (G9 : Env) (s6 : Tm) (T52 : Ty) (jm11 : (Typing G9 s6 T52)) :
  (forall (d0 : (Trace TmVar)) (G10 : Env) (G12 : Env) (sub : (subst_evar G9 T52 s6 d0 G10 G12)) (x15 : (Index TmVar)) (T53 : Ty) ,
...
(forall (G14 : Env) (d0 : (Trace TmVar)) (H60 : (subst_evar G12 T52 s6 d0 G11 G14)) ,
  (PTyping G14 p T G13)) :=
  match wtp11 in (PTyping _ p T G13) return (forall (G14 : Env) (d0 : (Trace TmVar)) (H60 : (subst_evar G12 T52 s6 d0 G11 G14)) ,
    (PTyping G14 p T G13)) with
    | (P_Var T53 H55) => (fun (G14 : Env) (d0 : (Trace TmVar)) (H60 : (subst_evar G12 T52 s6 d0 G11 G14)) =>
      (P_Var G14 T53 (substhvl_TmVar_wfTy _ _ H55 (weaken_substhvl_TmVar H0 (subst_evar_substhvl_TmVar _ H60)))))
    | (P_Prod T54 T55 p25 p26 G9 G10 wtp9 wtp10 H57) => (fun (G14 : Env) (d0 : (Trace TmVar)) (H60 : (subst_evar G12 T52 s6 d0 G11 G14)) =>
      (PTyping_cast G14 _ _ _ G14 (PProd p25 p26) (TProd T54 T55) _ eq_refl eq_refl eq_refl (eq_trans (f_equal2 appendEnv (eq_sym eq_refl) eq_refl) (eq_sym eq_refl)) (P_Prod G14 T54 T55 p25 p26 G9 G10 (subst_evar_PTyping G12 s6 T52 jm11 G11 p25 T54 G9 wtp9 G14 d0 (weaken_subst_evar _ empty H60)) (PTyping_cast _ _ _ _ _ _ _ _ (f_equal2 appendEnv eq_refl eq_refl) eq_refl (eq_trans eq_refl (eq_sym eq_refl)) eq_refl (subst_evar_PTyping G12 s6 T52 jm11 (appendEnv G11 (appendEnv empty G9)) p26 (weakenTy T55 (appendHvl H0 (bind p25))) G10 wtp10 (appendEnv G14 (appendEnv empty G9)) (weakenTrace d0 (domainEnv (appendEnv empty G9))) (weaken_subst_evar _ (appendEnv empty G9) H60))) (substhvl_TmVar_wfTy _ _ H57 (weaken_substhvl_TmVar H0 (subst_evar_substhvl_TmVar _ H60))))))
  end.
...
(forall (G14 : Env) (d0 : (Trace TyVar)) (H61 : (subst_etvar G12 S6 d0 G11 G14)) ,
  (PTyping G14 (tsubstPat d0 S6 p) (tsubstTy d0 S6 T) (tsubstEnv d0 S6 G13))) :=
  match wtp11 in (PTyping _ p T G13) return (forall (G14 : Env) (d0 : (Trace TyVar)) (H61 : (subst_etvar G12 S6 d0 G11 G14)) ,
    (PTyping G14 (tsubstPat d0 S6 p) (tsubstTy d0 S6 T) (tsubstEnv d0 S6 G13))) with
    | (P_Var T53 H55) => (fun (G14 : Env) (d0 : (Trace TyVar)) (H61 : (subst_etvar G12 S6 d0 G11 G14)) =>
      (P_Var G14 (tsubstTy (weakenTrace d0 H0) S6 T53) (substhvl_TyVar_wfTy H60 _ _ H55 (weaken_substhvl_TyVar H0 (subst_etvar_substhvl_TyVar H61)))))
    | (P_Prod T54 T55 p25 p26 G9 G10 wtp9 wtp10 H57) => (fun (G14 : Env) (d0 : (Trace TyVar)) (H61 : (subst_etvar G12 S6 d0 G11 G14)) =>
      (PTyping_cast G14 _ _ _ G14 (tsubstPat d0 S6 (PProd p25 p26)) (tsubstTy d0 S6 (TProd T54 T55)) _ eq_refl eq_refl eq_refl (eq_trans (f_equal2 appendEnv (eq_sym (tsubstEnv_appendEnv d0 S6 empty G9)) eq_refl) (eq_sym (tsubstEnv_appendEnv d0 S6 (appendEnv empty G9) G10))) (P_Prod G14 (tsubstTy (weakenTrace d0 H0) S6 T54) (tsubstTy (weakenTrace d0 H0) S6 T55) (tsubstPat (weakenTrace d0 H0) S6 p25) (tsubstPat (weakenTrace d0 (appendHvl H0 (bind p25))) S6 p26) (tsubstEnv (weakenTrace d0 H0) S6 G9) (tsubstEnv (weakenTrace d0 (domainEnv (appendEnv empty G9))) S6 G10) (subst_etvar_PTyping G12 S6 H60 G11 p25 T54 G9 wtp9 G14 d0 (weaken_subst_etvar empty H61)) (PTyping_cast _ _ _ _ _ _ _ _ (f_equal2 appendEnv eq_refl (tsubstEnv_appendEnv d0 S6 empty G9)) (f_equal3 tsubstPat (f_equal2 weakenTrace eq_refl (eq_trans (domainEnv_appendEnv empty G9) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G11 p25 T54 G9 wtp9)))) eq_refl eq_refl) (eq_trans (f_equal3 tsubstTy (f_equal2 weakenTrace eq_refl (eq_trans (domainEnv_appendEnv empty G9) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G11 p25 T54 G9 wtp9)))) eq_refl eq_refl) (eq_trans (eq_sym (weakenTy_tsubstTy (appendHvl H0 (bind p25)) d0 S6 T55)) (f_equal2 weakenTy eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (eq_sym (stability_tsubst_bind _ _ _)) (eq_refl H0)))))) eq_refl (subst_etvar_PTyping G12 S6 H60 (appendEnv G11 (appendEnv empty G9)) p26 (weakenTy T55 (appendHvl H0 (bind p25))) G10 wtp10 (appendEnv G14 (tsubstEnv d0 S6 (appendEnv empty G9))) (weakenTrace d0 (domainEnv (appendEnv empty G9))) (weaken_subst_etvar (appendEnv empty G9) H61))) (substhvl_TyVar_wfTy H60 _ _ H57 (weaken_substhvl_TyVar H0 (subst_etvar_substhvl_TyVar H61))))))
  end.
Fixpoint subst_evar_Typing (G11 : Env) (s6 : Tm) (T53 : Ty) (jm20 : (Typing G11 s6 T53)) (G10 : Env) (t : Tm) (T : Ty) (jm21 : (Typing G10 t T)) :
(forall (G12 : Env) (d0 : (Trace TmVar)) (H79 : (subst_evar G11 T53 s6 d0 G10 G12)) ,
  (Typing G12 (substTm d0 s6 t) T)) :=
  match jm21 in (Typing _ t T) return (forall (G12 : Env) (d0 : (Trace TmVar)) (H79 : (subst_evar G11 T53 s6 d0 G10 G12)) ,
    (Typing G12 (substTm d0 s6 t) T)) with
    | (T_Var T54 x15 lk2 H56 H57) => (fun (G12 : Env) (d0 : (Trace TmVar)) (H79 : (subst_evar G11 T53 s6 d0 G10 G12)) =>
      (subst_evar_lookup_evar G11 s6 T53 jm20 d0 G10 G12 H79 x15 T54 lk2))
    | (T_Abs T55 T58 t29 jm11 H58 H59) => (fun (G12 : Env) (d0 : (Trace TmVar)) (H79 : (subst_evar G11 T53 s6 d0 G10 G12)) =>
      (T_Abs G12 T55 T58 (substTm (weakenTrace d0 (HS TmVar H0)) s6 t29) (Typing_cast _ _ _ _ _ _ eq_refl eq_refl (eq_sym eq_refl) (subst_evar_Typing G11 s6 T53 jm20 (evar G10 T55) t29 (weakenTy T58 (HS TmVar H0)) jm11 (appendEnv G12 (evar empty T55)) (weakenTrace d0 (HS TmVar H0)) (weaken_subst_evar _ (evar empty T55) H79))) (substhvl_TmVar_wfTy _ _ H58 (weaken_substhvl_TmVar H0 (subst_evar_substhvl_TmVar _ H79))) (substhvl_TmVar_wfTy _ _ H59 (weaken_substhvl_TmVar H0 (subst_evar_substhvl_TmVar _ H79)))))
    | (T_App T56 T57 t30 t31 jm12 jm13) => (fun (G12 : Env) (d0 : (Trace TmVar)) (H79 : (subst_evar G11 T53 s6 d0 G10 G12)) =>
    ...
    | (T_Tabs T54 t29 jm14) => (fun (G12 : Env) (d0 : (Trace TmVar)) (H79 : (subst_evar G11 T53 s6 d0 G10 G12)) =>
      (T_Tabs G12 T54 (substTm (weakenTrace d0 (HS TyVar H0)) s6 t29) (subst_evar_Typing G11 s6 T53 jm20 (etvar G10) t29 T54 jm14 (appendEnv G12 (etvar empty)) (weakenTrace d0 (HS TyVar H0)) (weaken_subst_evar _ (etvar empty) H79))))
    | (T_Tapp T57 T58 t30 jm15 H68) => (fun (G12 : Env) (d0 : (Trace TmVar)) (H79 : (subst_evar G11 T53 s6 d0 G10 G12)) =>
      (T_Tapp G12 T57 T58 (substTm (weakenTrace d0 H0) s6 t30) (subst_evar_Typing G11 s6 T53 jm20 G10 t30 (TAll T57) jm15 G12 d0 (weaken_subst_evar _ empty H79)) (substhvl_TmVar_wfTy _ _ H68 (weaken_substhvl_TmVar H0 (subst_evar_substhvl_TmVar _ H79)))))
    | (T_Prod T55 T58 t30 t31 jm16 jm17) => (fun (G12 : Env) (d0 : (Trace TmVar)) (H79 : (subst_evar G11 T53 s6 d0 G10 G12)) =>
    ...
    | (T_Let T55 T58 p25 t30 t31 G9 jm18 wtp9 jm19 H75) => (fun (G12 : Env) (d0 : (Trace TmVar)) (H79 : (subst_evar G11 T53 s6 d0 G10 G12)) =>
      (T_Let G12 T55 T58 p25 (substTm (weakenTrace d0 H0) s6 t30) (substTm (weakenTrace d0 (appendHvl H0 (bind p25))) s6 t31) G9 (subst_evar_Typing G11 s6 T53 jm20 G10 t30 T55 jm18 G12 d0 (weaken_subst_evar _ empty H79)) (subst_evar_PTyping G11 s6 T53 jm20 G10 p25 T55 G9 wtp9 G12 d0 (weaken_subst_evar _ empty H79)) (Typing_cast _ _ _ _ _ _ (f_equal2 appendEnv eq_refl eq_refl) (f_equal3 substTm (f_equal2 weakenTrace eq_refl (eq_trans (domainEnv_appendEnv empty G9) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G10 p25 T55 G9 wtp9)))) eq_refl eq_refl) (eq_trans eq_refl (eq_sym eq_refl)) (subst_evar_Typing G11 s6 T53 jm20 (appendEnv G10 (appendEnv empty G9)) t31 (weakenTy T58 (appendHvl H0 (bind p25))) jm19 (appendEnv G12 (appendEnv empty G9)) (weakenTrace d0 (domainEnv (appendEnv empty G9))) (weaken_subst_evar _ (appendEnv empty G9) H79))) (substhvl_TmVar_wfTy _ _ H75 (weaken_substhvl_TmVar H0 (subst_evar_substhvl_TmVar _ H79)))))
  end.
Fixpoint subst_etvar_Typing (G11 : Env) (S6 : Ty) (H79 : (wfTy (domainEnv G11) S6)) (G10 : Env) (t : Tm) (T : Ty) (jm20 : (Typing G10 t T)) :
(forall (G12 : Env) (d0 : (Trace TyVar)) (H80 : (subst_etvar G11 S6 d0 G10 G12)) ,
  (Typing G12 (tsubstTm d0 S6 t) (tsubstTy d0 S6 T))) :=
  match jm20 in (Typing _ t T) return (forall (G12 : Env) (d0 : (Trace TyVar)) (H80 : (subst_etvar G11 S6 d0 G10 G12)) ,
    (Typing G12 (tsubstTm d0 S6 t) (tsubstTy d0 S6 T))) with
    | (T_Var T54 x15 lk2 H56 H57) => (fun (G12 : Env) (d0 : (Trace TyVar)) (H80 : (subst_etvar G11 S6 d0 G10 G12)) =>
      (T_Var G12 (tsubstTy (weakenTrace d0 H0) S6 T54) x15 (subst_etvar_lookup_evar H79 H80 T54 lk2) (substhvl_TyVar_wfTy H79 _ _ H56 (weaken_substhvl_TyVar H0 (subst_etvar_substhvl_TyVar H80))) (substhvl_TyVar_wfindex_TmVar (weaken_substhvl_TyVar H0 (subst_etvar_substhvl_TyVar H80)) H57)))
    | (T_Abs T55 T58 t29 jm11 H58 H59) => (fun (G12 : Env) (d0 : (Trace TyVar)) (H80 : (subst_etvar G11 S6 d0 G10 G12)) =>
      (T_Abs G12 (tsubstTy (weakenTrace d0 H0) S6 T55) (tsubstTy (weakenTrace d0 H0) S6 T58) (tsubstTm (weakenTrace d0 (HS TmVar H0)) S6 t29) (Typing_cast _ _ _ _ _ _ eq_refl eq_refl (eq_sym (weakenTy_tsubstTy (HS TmVar H0) d0 S6 T58)) (subst_etvar_Typing G11 S6 H79 (evar G10 T55) t29 (weakenTy T58 (HS TmVar H0)) jm11 (appendEnv G12 (tsubstEnv d0 S6 (evar empty T55))) (weakenTrace d0 (HS TmVar H0)) (weaken_subst_etvar (evar empty T55) H80))) (substhvl_TyVar_wfTy H79 _ _ H58 (weaken_substhvl_TyVar H0 (subst_etvar_substhvl_TyVar H80))) (substhvl_TyVar_wfTy H79 _ _ H59 (weaken_substhvl_TyVar H0 (subst_etvar_substhvl_TyVar H80)))))
    | (T_App T56 T57 t30 t31 jm12 jm13) => (fun (G12 : Env) (d0 : (Trace TyVar)) (H80 : (subst_etvar G11 S6 d0 G10 G12)) =>
    ...
    | (T_Tabs T54 t29 jm14) => (fun (G12 : Env) (d0 : (Trace TyVar)) (H80 : (subst_etvar G11 S6 d0 G10 G12)) =>
      (T_Tabs G12 (tsubstTy (weakenTrace d0 (HS TyVar H0)) S6 T54) (tsubstTm (weakenTrace d0 (HS TyVar H0)) S6 t29) (subst_etvar_Typing G11 S6 H79 (etvar G10) t29 T54 jm14 (appendEnv G12 (tsubstEnv d0 S6 (etvar empty))) (weakenTrace d0 (HS TyVar H0)) (weaken_subst_etvar (etvar empty) H80))))
    | (T_Tapp T57 T58 t30 jm15 H68) => (fun (G12 : Env) (d0 : (Trace TyVar)) (H80 : (subst_etvar G11 S6 d0 G10 G12)) =>
      (Typing_cast G12 _ _ G12 (tsubstTm d0 S6 (TApp t30 T58)) (tsubstTy d0 S6 (tsubstTy X0 T58 T57)) eq_refl eq_refl (eq_sym (tsubstTy_tsubstTy0_comm T57 d0 S6 T58)) (T_Tapp G12 (tsubstTy (weakenTrace d0 (HS TyVar H0)) S6 T57) (tsubstTy (weakenTrace d0 H0) S6 T58) (tsubstTm (weakenTrace d0 H0) S6 t30) (subst_etvar_Typing G11 S6 H79 G10 t30 (TAll T57) jm15 G12 d0 (weaken_subst_etvar empty H80)) (substhvl_TyVar_wfTy H79 _ _ H68 (weaken_substhvl_TyVar H0 (subst_etvar_substhvl_TyVar H80))))))
    | (T_Prod T55 T58 t30 t31 jm16 jm17) => (fun (G12 : Env) (d0 : (Trace TyVar)) (H80 : (subst_etvar G11 S6 d0 G10 G12)) =>
    ...
    | (T_Let T55 T58 p25 t30 t31 G9 jm18 wtp9 jm19 H75) => (fun (G12 : Env) (d0 : (Trace TyVar)) (H80 : (subst_etvar G11 S6 d0 G10 G12)) =>
      (T_Let G12 (tsubstTy (weakenTrace d0 H0) S6 T55) (tsubstTy (weakenTrace d0 H0) S6 T58) (tsubstPat (weakenTrace d0 H0) S6 p25) (tsubstTm (weakenTrace d0 H0) S6 t30) (tsubstTm (weakenTrace d0 (appendHvl H0 (bind p25))) S6 t31) (tsubstEnv (weakenTrace d0 H0) S6 G9) (subst_etvar_Typing G11 S6 H79 G10 t30 T55 jm18 G12 d0 (weaken_subst_etvar empty H80)) (subst_etvar_PTyping G11 S6 H79 G10 p25 T55 G9 wtp9 G12 d0 (weaken_subst_etvar empty H80)) (Typing_cast _ _ _ _ _ _ (f_equal2 appendEnv eq_refl (tsubstEnv_appendEnv d0 S6 empty G9)) (f_equal3 tsubstTm (f_equal2 weakenTrace eq_refl (eq_trans (domainEnv_appendEnv empty G9) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G10 p25 T55 G9 wtp9)))) eq_refl eq_refl) (eq_trans (f_equal3 tsubstTy (f_equal2 weakenTrace eq_refl (eq_trans (domainEnv_appendEnv empty G9) (f_equal2 appendHvl (eq_refl H0) (domain_PTyping_bind G10 p25 T55 G9 wtp9)))) eq_refl eq_refl) (eq_trans (eq_sym (weakenTy_tsubstTy (appendHvl H0 (bind p25)) d0 S6 T58)) (f_equal2 weakenTy eq_refl (f_equal2 appendHvl (eq_refl H0) (f_equal2 appendHvl (eq_sym (stability_tsubst_bind _ _ _)) (eq_refl H0)))))) (subst_etvar_Typing G11 S6 H79 (appendEnv G10 (appendEnv empty G9)) t31 (weakenTy T58 (appendHvl H0 (bind p25))) jm19 (appendEnv G12 (tsubstEnv d0 S6 (appendEnv empty G9))) (weakenTrace d0 (domainEnv (appendEnv empty G9))) (weaken_subst_etvar (appendEnv empty G9) H80))) (substhvl_TyVar_wfTy H79 _ _ H75 (weaken_substhvl_TyVar H0 (subst_etvar_substhvl_TyVar H80)))))
  end.
